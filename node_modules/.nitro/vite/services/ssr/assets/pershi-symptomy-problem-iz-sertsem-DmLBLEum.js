import { a as SiteHeader, d as cpet_test_default, l as ergometer_default, o as CONTACTS, t as SiteFooter, u as ecg_review_default, y as AppLink } from "./site-footer-DtdGqSzK.js";
import { r as PageContainer, t as Breadcrumbs } from "./blocks-x0lAFLuX.js";
import "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, ArrowRight, CalendarDays, Check, Clock, HeartPulse, Phone, Stethoscope } from "lucide-react";
//#region src/routes/statti/pershi-symptomy-problem-iz-sertsem.tsx?tsr-split=component
var breadcrumbs = [
	{
		title: "Головна",
		route: "/"
...
function MetaItem({ icon: Icon, label, value }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Icon, { className: "size-5 shrink-0 text-brand-green" }), /* @__PURE__ */ jsxs("div", {
			className: "min-w-0",
...
function Section({ id, title, children }) {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "mt-5 h-1 w-14 rounded-full bg-primary" }),
			/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("main", { children: [
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-navy-deep via-navy-deep/92 to-navy-deep/25" }),
						/* @__PURE__ */ jsxs("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("nav", {
										...
										children: articleSections.map((section) => /* @__PURE__ */ jsx("a", {
											href: `#${section.id}`,
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("p", { children: "Серцево-судинні захворювання часто розвиваються поступово: спершу людина помічає втому, задишку або нестабільний тиск, але пояснює це стресом, віком чи навантаженням. Планова консультація кардіолога допомагає відрізнити тимчасове нездужання від станів, які потребують спостереження або лікування." }), /* @__PURE__ */ jsx("p", { children: "Ця стаття має інформаційний характер і не замінює медичної консультації. Якщо симптоми інтенсивні, з’явилися раптово або швидко посилюються, краще не відкладати звернення по невідкладну допомогу." })]
											}), /* @__PURE__ */ jsx("img", {
										...
										/* @__PURE__ */ jsxs(Section, {
											id: "symptoms",
											title: "Симптоми, які варто обговорити з кардіологом",
											children: [/* @__PURE__ */ jsx("p", { children: "Звернення до фахівця доречне не лише тоді, коли з’являється біль. На роботу серця можуть вказувати зміни витривалості, ритму, тиску та загального самопочуття." }), /* @__PURE__ */ jsx("ul", {
												className: "space-y-3",
												children: symptoms.map((item) => /* @__PURE__ */ jsxs("li", {
													className: "flex gap-3",
													children: [/* @__PURE__ */ jsx("span", { className: "mt-2 size-2 shrink-0 rounded-full bg-primary" }), /* @__PURE__ */ jsx("span", { children: item })]
												}, item))
											})]
										}),
										/* @__PURE__ */ jsxs(Section, {
											...
											children: [/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsxs("div", {
													className: "flex gap-3",
													children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "mt-1 size-5 shrink-0 text-destructive" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
											...
											}), /* @__PURE__ */ jsx("p", { children: "Якщо симптоми повторюються, але не мають ознак невідкладного стану, варто запланувати огляд. Лікар збере анамнез, оцінить фактори ризику та визначить, які обстеження потрібні саме у вашому випадку." })]
										}),
										/* @__PURE__ */ jsxs(Section, {
											id: "diagnostics",
											title: "Що може входити в кардіодіагностику",
											children: [
												/* @__PURE__ */ jsx("p", { children: "Набір досліджень залежить від скарг, віку, супутніх захворювань, рівня фізичної активності та попередніх висновків. В ОСНОВІ кардіодіагностику підбирають так, щоб отримати достатньо даних для безпечних рекомендацій." }),
												/* @__PURE__ */ jsx("div", {
													className: "grid gap-4 sm:grid-cols-2",
													children: diagnostics.map((item) => /* @__PURE__ */ jsxs("div", {
														className: "rounded-xl border border-border bg-card p-5 shadow-sm",
														children: [/* @__PURE__ */ jsxs("div", {
															className: "flex items-center gap-3",
															children: [/* @__PURE__ */ jsx("span", {
																className: "flex size-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary",
																children: /* @__PURE__ */ jsx(HeartPulse, { className: "size-5" })
															}), /* @__PURE__ */ jsx("h3", {
														...
														children: [/* @__PURE__ */ jsx("img", {
															...
															children: [
																...
																/* @__PURE__ */ jsxs(AppLink, {
																	...
																	children: ["Дивитися послуги ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
																})
															]
														})]
													})
										...
										/* @__PURE__ */ jsxs(Section, {
											id: "prepare",
											title: "Як підготуватися до консультації",
											children: [/* @__PURE__ */ jsx("p", { children: "Чим точніше ви опишете симптоми та покажете попередні результати, тим швидше лікар складе зрозумілий план дій." }), /* @__PURE__ */ jsx("ul", {
												className: "space-y-4",
												children: preparation.map((item) => /* @__PURE__ */ jsxs("li", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(AppLink, {
											...
											children: ["Кардіодіагностика ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
										})]
									})
								]
							})]
