import { a as SiteHeader, t as SiteFooter, v as cn, y as AppLink } from "./site-footer-DpAKTwkw.js";
...
import { ArrowRight, CalendarDays, Clock3, Newspaper, Phone } from "lucide-react";
//#region src/components/news-card.tsx
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(CalendarDays, { className: "size-3.5" }), article.category]
					}), /* @__PURE__ */ jsxs("span", {
						className: "inline-flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx(Clock3, { className: "size-3.5" }), article.readTime]
					})]
				}),
				/* @__PURE__ */ jsx("h3", {
...
//#endregion
//#region src/routes/novyny.tsx?tsr-split=component
			...
			/* @__PURE__ */ jsxs("main", { children: [
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-navy-deep via-navy-deep/90 to-navy-deep/30" }),
						/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsx(PageContainer, { children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: /* @__PURE__ */ jsx(Newspaper, { className: "size-5" })
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs(PageContainer, { children: [featuredArticle && /* @__PURE__ */ jsx(NewsCard, {
						article: featuredArticle,
						variant: "featured"
					}), restArticles.length > 0 && /* @__PURE__ */ jsx("div", {
						className: "mt-8 grid gap-8 md:grid-cols-2 xl:grid-cols-3",
						children: restArticles.map((article) => /* @__PURE__ */ jsx(NewsCard, { article }, article.id))
					})] })
				}),
				/* @__PURE__ */ jsx("section", {
