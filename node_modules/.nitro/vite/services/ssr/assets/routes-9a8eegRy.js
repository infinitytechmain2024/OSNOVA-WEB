...
import { a as partner_ifnmu_default, c as partner_asmu_default, i as partner_karpatska_akademiia_default, n as companyOverviewCtaClassName, o as partner_heart_default, r as partner_sytenko_default, s as partner_chnu_default, t as CompanyOverviewSection } from "./company-overview-section-5mMhiogy.js";
import { t as NEWS_ARTICLES } from "./news-CC6aDEk-.js";
import * as React from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, ArrowRight, ArrowUpRight, BookOpen, Brain, Calendar, CalendarDays, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardList, Dumbbell, Flame, FlaskConical, GraduationCap, Heart, Home, MapPin, MessageCircle, Microscope, Network, Phone, ShieldCheck, Stethoscope, Trophy, UserCheck, Users, Zap } from "lucide-react";
...
//#endregion
//#region src/components/cooperation-cascade.tsx
...
function CooperationCascade({ items = COOPERATION_ITEMS, initialIndex = 1 }) {
	const [activeIndex, setActiveIndex] = React.useState(Math.min(Math.max(initialIndex, 0), items.length - 1));
	const [pendingIndex, setPendingIndex] = React.useState(null);
	const [motionDirection, setMotionDirection] = React.useState(1);
	const wheelLockRef = React.useRef(false);
	const prepareTimeoutRef = React.useRef(null);
	const releaseTimeoutRef = React.useRef(null);
	...
	const moveToIndex = React.useCallback((nextIndex) => {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs(AppLink, {
										...
										children: ["Детальніше", /* @__PURE__ */ jsx(ArrowRight, {
											className: "size-4",
											strokeWidth: 2
										})]
									})
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(CarouselNavigation, {
...
//#endregion
//#region src/assets/home/balance-reference-card.png
var balance_reference_card_default = "/assets/balance-reference-card-BIQa2b6b.png";
//#endregion
//#region src/assets/about/medical-assessment.jpg
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: expanded ? "Згорнути" : "Детальніше" }), /* @__PURE__ */ jsx(ChevronDown, { className: cn("size-4 transition-transform duration-200", expanded && "rotate-180") })]
				}), /* @__PURE__ */ jsxs(AppLink, {
					to: direction.href,
					className: "inline-flex items-center gap-2 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:scale-105 hover:bg-primary/90 hover:shadow-md",
					children: [
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("a", {
					...
					children: [/* @__PURE__ */ jsx(Home, { className: "size-4 shrink-0" }), /* @__PURE__ */ jsx("span", { children: "Головна" })]
				}),
				/* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: HOME_PAGE_SECTION_LINKS.map((item) => /* @__PURE__ */ jsx("a", {
						href: item.href,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", { children: [
				...
				/* @__PURE__ */ jsx(HomePageAnchorNav, {}),
				/* @__PURE__ */ jsx(CompanyOverviewSection, {
					id: "about-company",
					className: "scroll-mt-24",
					cta: /* @__PURE__ */ jsxs(AppLink, {
						to: "/pro-osnovu",
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "mx-auto mt-5 h-1 w-[62px] rounded-full bg-gradient-to-r from-[#2467D8] to-[#42B883]" }),
								/* @__PURE__ */ jsx("p", {
							...
							children: /* @__PURE__ */ jsx(CooperationCascade, {})
						})]
					})
				}),
				/* @__PURE__ */ jsx("section", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Accordion, {
								...
								children: (faqExpanded ? FAQS : FAQS.slice(0, FAQ_VISIBLE_COUNT)).map((faq, i) => /* @__PURE__ */ jsxs(AccordionItem, {
									value: `item-${i}`,
							...
							FAQS.length > FAQ_VISIBLE_COUNT && /* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: [faqExpanded ? "Показати менше питань" : "Показати більше питань", /* @__PURE__ */ jsx(ChevronDown, { className: `size-5 transition-transform duration-300 ${faqExpanded ? "rotate-180" : ""}` })]
								})
							})
						]
					}), /* @__PURE__ */ jsx("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("span", {
											...
											children: [/* @__PURE__ */ jsx(MessageCircle, { className: "size-4" }), "Індивідуальна консультація"]
										}),
										/* @__PURE__ */ jsxs("div", {
										...
										/* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("button", {
											...
											children: ["Зв'язатися з нами ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-5" })]
										}) })
									]
								}), /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-y-0 left-0 w-28 bg-gradient-to-r from-white via-white/85 to-transparent blur-2xl sm:w-36 lg:w-44" }),
										/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-navy/8 via-transparent to-white/10" })
									]
								})]
							})
						})
