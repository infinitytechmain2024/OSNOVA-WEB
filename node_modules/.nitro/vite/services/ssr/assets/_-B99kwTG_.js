...
import { t as Route$1 } from "./_-zb5DNac_.js";
...
import { Activity, AlertTriangle, Ambulance, ArrowRight, BadgeCheck, BookOpen, Building2, CalendarDays, ChartLine, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardCheck, ClipboardList, ClipboardPenLine, Clock, Compass, Dumbbell, ExternalLink, FileSearch, FileText, FlaskConical, GraduationCap, HandHeart, Handshake, Heart, HeartPulse, Home, Layers, Mail, MapPin, MapPinned, MessageCircle, MessageSquare, Microscope, Navigation, Package, Percent, Phone, PhoneCall, Presentation, Route, Search, Send, Share2, ShieldAlert, ShieldCheck, Sparkles, Stethoscope, Truck, UserRoundCheck, Users, Wrench } from "lucide-react";
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[linear-gradient(90deg,rgba(4,15,44,0.96)_0%,rgba(4,15,44,0.92)_30%,rgba(16,33,78,0.76)_56%,rgba(22,39,82,0.58)_72%,rgba(36,51,93,0.34)_100%)]" }),
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("button", {
												...
												children: ["Замовити консультацію", /* @__PURE__ */ jsx(ArrowRight, { className: "size-5" })]
											})
										]
									})
								})
