import { _ as useConsultationModal, a as SiteHeader, d as cpet_test_default, f as service_sports_default, l as ergometer_default, m as service_rehab_default, p as service_checkup_default, t as SiteFooter, u as ecg_review_default, v as cn, y as AppLink } from "./site-footer-DpAKTwkw.js";
import { n as education_conference_default, t as education_training_default } from "./education-training-D0E3Ecw7.js";
import { a as partner_chnu_default, i as partner_heart_default, n as partner_karpatska_akademiia_default, o as partner_asmu_default, r as partner_ifnmu_default, t as partner_sytenko_default } from "./partner-sytenko-Oay8tZk6.js";
import { t as NEWS_ARTICLES } from "./news-C188zRFJ.js";
import * as React from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, ArrowRight, BookOpen, Brain, Calendar, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardList, Dumbbell, Flame, GraduationCap, Heart, Microscope, Network, Phone, ShieldCheck, Stethoscope, Trophy, UserCheck, Users, Zap } from "lucide-react";
...
//#endregion
//#region src/components/rehabilitation-methods-slider.tsx
...
function ArrowLeftIcon({ className }) {
	return /* @__PURE__ */ jsxs("svg", {
		...
		className,
		"aria-hidden": "true",
		children: [/* @__PURE__ */ jsx("path", { d: "M19 12H5" }), /* @__PURE__ */ jsx("path", { d: "m12 19-7-7 7-7" })]
	});
}
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				children: [
					"Детальніше",
					" ",
					/* @__PURE__ */ jsx(ArrowRightIcon, { className: "size-4 transition-transform group-hover:translate-x-1" })
				]
			}) })]
		})]
	});
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("h3", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "h-px w-full bg-white/15" }),
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
					className: "block text-5xl font-extrabold tracking-tight",
					children: "30+"
				}), /* @__PURE__ */ jsxs("span", {
...
function SectionHeader$1() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "mx-auto mt-6 h-1.5 w-24 rounded-full bg-gradient-to-r from-primary to-brand-green" }),
			/* @__PURE__ */ jsx("p", {
...
function RehabilitationMethodsSlider() {
	const [methodsApi, setMethodsApi] = React.useState();
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(StatsPanel, {}), /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Carousel, {
							...
							children: /* @__PURE__ */ jsx(CarouselContent, {
								...
								children: REHABILITATION_METHODS.map((card) => /* @__PURE__ */ jsx(CarouselItem, {
									className: "pl-4 basis-[85%] sm:basis-[48%] lg:basis-[45%] xl:basis-[32%] !h-auto",
									children: /* @__PURE__ */ jsx(MethodCard, { card })
								}, card.id))
							})
						})
					})]
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(ArrowLeftIcon, { className: "size-5" })
							}),
							/* @__PURE__ */ jsx("div", {
								className: "flex items-center justify-center gap-2.5",
								children: REHABILITATION_METHODS.map((card, index) => /* @__PURE__ */ jsx("button", {
									type: "button",
							...
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(ArrowRightIcon, { className: "size-5" })
							})
						]
					})
				})
	...
	return /* @__PURE__ */ jsxs(AppLink, {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-navy-deep/40" }),
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-navy-deep/75 via-navy-deep/20 to-navy-deep/5" }),
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(Icon, { className: "size-4" }), item.label]
					})
				})
			]
		}), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(Users, { className: "size-3.5" }), item.audience]
					}), /* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(Calendar, { className: "size-3.5 text-brand-green" }), item.format]
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
...
function CooperationCard({ item, index, isActive = false, isAdjacentVisible = false, onClick }) {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: item.tags[0] }), /* @__PURE__ */ jsx("span", { children: item.tags[1] })]
				}),
				/* @__PURE__ */ jsx("span", {
	...
	if (isAdjacentVisible) return /* @__PURE__ */ jsx("button", {
		onClick,
		type: "button",
	...
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsx("div", { className: "mt-4 mb-8 h-1.5 w-20 rounded-full bg-gradient-to-r from-sky-400 via-emerald-400 to-[#22C55E]" }),
				/* @__PURE__ */ jsx("p", {
				...
				children: ["Усі статті ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-5" })]
			})]
		}), visible.map((article) => {
			...
			return /* @__PURE__ */ jsxs("article", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs(AppLink, {
					to: article.href,
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(CategoryIcon, { className: "size-4" }),
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: Array.from({ length: totalPages }).map((_, i) => /* @__PURE__ */ jsx("button", {
						type: "button",
...
function Index() {
	...
	const [directionsApi, setDirectionsApi] = React.useState();
	...
	const [partnersApi, setPartnersApi] = React.useState();
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", { children: [
					...
					children: /* @__PURE__ */ jsxs(Carousel, {
						...
						children: [
							/* @__PURE__ */ jsx(CarouselContent, {
								...
								children: HERO_SLIDES.map((slide, index) => /* @__PURE__ */ jsxs(CarouselItem, {
											...
											children: /* @__PURE__ */ jsxs("div", {
												...
												children: [
													/* @__PURE__ */ jsxs("span", {
														...
														children: [/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-primary animate-pulse" }), slide.subtitle]
													}),
													/* @__PURE__ */ jsx("h1", {
													...
													/* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsxs("button", {
															...
															}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 -translate-x-full bg-white/20 transition-transform duration-300 group-hover:translate-x-0" })]
														}), /* @__PURE__ */ jsxs(AppLink, {
															to: "/poslugy",
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute -left-[8%] top-[18%] h-[420px] w-[420px] rounded-full bg-[#bfe3ff]/50 blur-[120px]" }),
						/* @__PURE__ */ jsx("div", { className: "absolute -right-[5%] bottom-[8%] h-[360px] w-[360px] rounded-full bg-[#d9f0ff]/70 blur-[100px]" }),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("div", { className: "mb-8 h-1.5 w-24 rounded-full bg-gradient-to-r from-[#0d66d9] via-[#5ebaf9] to-[#8be0d8]" }),
										/* @__PURE__ */ jsxs("div", {
											className: "space-y-5 text-[17px] leading-relaxed text-[#3d5875] md:text-[18px]",
											children: [
												/* @__PURE__ */ jsx("p", { children: "«ОСНОВА Реабілітація — сучасна медична компанія, що спеціалізується на лікуванні та комплексній реабілітації пацієнтів у сферах кардіології, ортопедії, травматології, ревматології, вертебрології та психології.»" }),
												/* @__PURE__ */ jsx("p", { children: "«Ми працюємо не лише з наслідками хвороб і травм, а й виявляємо ризики ще до появи симптомів — завдяки сучасній діагностиці, точним обстеженням і персоналізованим профілактичним програмам.»" }),
												/* @__PURE__ */ jsx("p", {
												...
												/* @__PURE__ */ jsx("p", { children: "«ОСНОВА Реабілітація також є науково-освітньою платформою, що розробляє та вдосконалює протоколи лікування, співпрацює з провідними медичними університетами світу, впроваджує інноваційні технології та розвиває виїзні формати реабілітаційної допомоги для пацієнтів поза центром.»" })
											]
										}),
										/* @__PURE__ */ jsx("div", {
											className: "mt-9",
											children: /* @__PURE__ */ jsxs(AppLink, {
												...
												children: ["ДЕТАЛЬНІШЕ ", /* @__PURE__ */ jsx("span", {
													"aria-hidden": "true",
													children: "→"
												})]
											})
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: DIRECTIONS.map((direction, index) => /* @__PURE__ */ jsx(DirectionCard, { direction }, index))
							}),
							/* @__PURE__ */ jsxs(Carousel, {
								...
								children: [/* @__PURE__ */ jsx(CarouselContent, {
									className: "-ml-4",
									children: DIRECTIONS.map((direction, index) => /* @__PURE__ */ jsx(CarouselItem, {
										className: "basis-[84%] pl-4",
										children: /* @__PURE__ */ jsx(DirectionCard, { direction })
									}, index))
								}), /* @__PURE__ */ jsxs("div", {
									className: "mt-10 flex flex-col items-center gap-6 sm:hidden",
									children: [directionsSlideCount > 0 && /* @__PURE__ */ jsx("div", {
										className: "flex items-center justify-center gap-2.5",
										children: Array.from({ length: directionsSlideCount }).map((_, index) => /* @__PURE__ */ jsx("button", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute -left-20 top-8 size-56 rounded-full bg-primary/10 blur-3xl" }),
						/* @__PURE__ */ jsx("div", { className: "absolute -right-16 bottom-6 size-72 rounded-full bg-emerald-300/20 blur-3xl" }),
						/* @__PURE__ */ jsx("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("button", {
											...
											children: [/* @__PURE__ */ jsx(Phone, { className: "size-5" }), "+380 674 702 788"]
										})]
									})
								]
							})
				...
				/* @__PURE__ */ jsx(RehabilitationMethodsSlider, {}),
				/* @__PURE__ */ jsx("section", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "mx-auto mb-6 h-1 w-24 rounded-full bg-gradient-to-r from-primary via-emerald-400 to-primary" }),
									/* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(SectionHeader, {
							...
							children: [/* @__PURE__ */ jsx(CarouselContent, {
								className: "-ml-5",
								children: PARTNER_GROUPS.map((group, index) => /* @__PURE__ */ jsx(CarouselItem, {
									className: "basis-full pl-5",
									children: /* @__PURE__ */ jsx("div", {
										className: "grid gap-6 md:grid-cols-3",
										children: group.map((partner) => /* @__PURE__ */ jsx(PartnerCard, { partner }, partner.name))
									})
								}, index))
							}), /* @__PURE__ */ jsxs("div", {
								className: "mt-10 flex flex-col items-center gap-6",
								children: [partnersSlideCount > 0 && /* @__PURE__ */ jsx("div", {
									className: "flex items-center justify-center gap-2.5",
									children: Array.from({ length: partnersSlideCount }).map((_, index) => /* @__PURE__ */ jsx("button", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(SectionHeader, {
							...
							children: EDUCATION_CARDS.map((item) => /* @__PURE__ */ jsx(EducationCard, { item }, item.title))
						})]
					})
				}),
				/* @__PURE__ */ jsx("section", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("div", {
									...
									children: COOPERATION_ITEMS.map((item, index) => {
										...
										return /* @__PURE__ */ jsx(CooperationCard, {
											item,
											index,
								...
								children: [
									/* @__PURE__ */ jsx("button", {
										...
										children: /* @__PURE__ */ jsx(ChevronUp, { className: "size-6" })
									}),
									/* @__PURE__ */ jsx("div", {
										className: "flex flex-row lg:flex-col gap-2.5",
										children: COOPERATION_ITEMS.map((_, index) => /* @__PURE__ */ jsx("button", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsx("div", {
						className: "mx-auto max-w-[1600px] px-6 lg:px-10",
						children: /* @__PURE__ */ jsx(BlogCarousel, {})
					})
				}),
				/* @__PURE__ */ jsx("section", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-[10%] top-[30%] size-[500px] rounded-full bg-primary/5 blur-[120px]" }), /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx(SectionHeader, {
									...
									title: /* @__PURE__ */ jsxs(Fragment, { children: ["Сучасні методи ", /* @__PURE__ */ jsx("span", {
										className: "text-primary",
										children: "відновлення"
									})] })
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										children: "Ми використовуємо комплексний підхід, поєднуючи різноманітні методи під завдання пацієнта."
									}), /* @__PURE__ */ jsx("p", { children: "Індивідуальна програма, фізична терапія, гідрокінезіотерапія, фізіотерапія та лікувальний масаж — кожен метод підбирається з урахуванням стану здоров'я та цілей відновлення." })]
								}),
								/* @__PURE__ */ jsx("div", {
									className: "mt-10",
									children: /* @__PURE__ */ jsxs(AppLink, {
										...
										children: ["ДЕТАЛЬНІШЕ ", /* @__PURE__ */ jsx(ChevronRight, { className: "size-5" })]
									})
								})
							] }), /* @__PURE__ */ jsx("div", {
