import { C as cn, S as useConsultationModal, _ as service_sports_default, a as SiteFooter, b as ConsultationForm, c as getNodeByRoute, d as IMAGES, f as siteTree, g as cpet_test_default, h as ecg_review_default, i as SectionHeader$1, l as SiteHeader, m as ergometer_default, n as FAQAccordion, o as getBreadcrumbs, p as CARDIO_REHAB_PROGRAMS, r as PageContainer, s as getNodeById, t as Breadcrumbs, u as CONTACTS, v as service_checkup_default, w as AppLink, y as service_rehab_default } from "./blocks-YQtB1Ncn.js";
import { t as Route$1 } from "./_-BUwDPzbE.js";
import { n as getServicePageData, r as OtherServices, t as ServiceDetailTemplate } from "./service-detail-template-DynFR6wY.js";
...
import { Activity, AlertTriangle, Ambulance, ArrowRight, BadgeCheck, BookOpen, Building2, CalendarDays, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardCheck, ClipboardList, ClipboardPlus, Clock, Compass, Dumbbell, ExternalLink, FileText, FlaskConical, GraduationCap, HandHeart, Handshake, Heart, HeartPulse, Home, Layers, Mail, MapPin, MapPinned, MessageCircle, MessageSquare, Microscope, Navigation, Package, Phone, PhoneCall, Presentation, Route, Search, Send, Share2, ShieldCheck, Sparkles, Stethoscope, Truck, UploadCloud, UserRoundCheck, Users, Wrench } from "lucide-react";
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						"aria-hidden": true,
						children: SUPPORT_HIGHLIGHTS.map((item, index) => /* @__PURE__ */ jsx("span", { className: cn("h-1 flex-1 rounded-full transition-colors duration-300", index === activeIndex ? "bg-primary" : "bg-primary/10") }, item.id))
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "mt-5 flex items-center justify-between gap-3 text-[11px] font-bold uppercase tracking-[0.16em] text-navy/55",
						children: [/* @__PURE__ */ jsx("span", { children: activeHighlight.eyebrow }), /* @__PURE__ */ jsxs("span", { children: [
