import { C as Dialog, D as DialogTitle, E as DialogHeader, O as cn, S as useConsultationModal, T as DialogDescription, _ as service_sports_default, a as SiteFooter, b as ConsultationForm, c as getNodeByRoute, d as IMAGES, f as siteTree, g as cpet_test_default, h as ecg_review_default, i as SectionHeader$1, k as AppLink, l as SiteHeader, m as ergometer_default, n as FAQAccordion, o as getBreadcrumbs, p as CARDIO_REHAB_PROGRAMS, r as PageContainer, s as getNodeById, t as Breadcrumbs, u as CONTACTS, v as service_checkup_default, w as DialogContent, y as service_rehab_default } from "./blocks-BPLbqWhS.js";
import { t as Route$1 } from "./_-Oe5gCtXi.js";
import { n as getServicePageData, r as OtherServices, t as ServiceDetailTemplate } from "./service-detail-template-BDFTBUiz.js";
import { n as education_conference_default, t as education_training_default } from "./education-training-D0E3Ecw7.js";
import { a as FAQConsultationCTA, c as partner_karpatska_akademiia_default, d as partner_chnu_default, f as partner_asmu_default, i as cardio_rehab_cta_photo_v3_default, l as partner_ifnmu_default, n as companyOverviewCtaClassName, o as medical_assessment_default, r as balance_reference_card_default, s as partner_sytenko_default, t as CompanyOverviewSection, u as partner_heart_default } from "./company-overview-section-vfTlHBRv.js";
import * as React from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Activity, AlertTriangle, Ambulance, ArrowRight, BadgeCheck, BookOpen, Building2, CalendarCheck2, CalendarDays, ChartLine, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardCheck, ClipboardList, ClipboardPenLine, Clock, Compass, Dumbbell, ExternalLink, FileSearch, FileText, FlaskConical, GraduationCap, HandHeart, Handshake, Heart, HeartPulse, Home, Info, Layers, Mail, MapPin, MapPinned, MessageCircle, MessageSquare, Microscope, Navigation, Package, Percent, Phone, PhoneCall, Presentation, Route, Search, Send, Share2, ShieldAlert, ShieldCheck, Sparkles, Stethoscope, Truck, UserRoundCheck, Users, Wrench } from "lucide-react";
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsx(SectionHeader$1, {
								...
								children: PROCESS_STEPS$3.map((step, index) => /* @__PURE__ */ jsxs("li", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", { children: [
				...
				/* @__PURE__ */ jsx(AnchorNav, { breadcrumbItems: getBreadcrumbs(node) }),
				/* @__PURE__ */ jsx("section", {
					id: "for-whom",
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: PROCESS_STEPS$2.map((step, index) => {
										...
										return /* @__PURE__ */ jsxs("article", {
											...
											children: [
												index < PROCESS_STEPS$2.length - 1 && /* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							children: [programCards.map((program) => /* @__PURE__ */ jsx(ProgramCard, { program }, program.id)), /* @__PURE__ */ jsx(SupportHighlightsCard, {})]
						})]
					})
				}),
			...
			children: [/* @__PURE__ */ jsx(Breadcrumbs, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						children: ANCHORS$1.map((item) => /* @__PURE__ */ jsx("a", {
							href: item.href,
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				children: card.text
			})] }), /* @__PURE__ */ jsx("div", { children: isPostInfarctionCard ? /* @__PURE__ */ jsxs(AppLink, {
				to: infarctionRoute,
				...
				children: ["Детальніше", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4 transition-transform group-hover:translate-x-1" })]
			}) : /* @__PURE__ */ jsxs("a", {
				href: "#documents",
				onClick: (e) => {
					e.preventDefault();
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						}), SUPPORT_HIGHLIGHTS.map((highlight, index) => /* @__PURE__ */ jsx("button", {
							type: "button",
							role: "tab",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						"aria-live": "polite",
						children: [
							/* @__PURE__ */ jsx(SupportHighlightVisual, { highlight: activeHighlight }),
							/* @__PURE__ */ jsx("div", {
...
function SupportHighlightVisual({ highlight }) {
	if (highlight.id === "senior") return /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "absolute bottom-0 left-2.5 flex items-center gap-1.5 rounded-[16px] border border-emerald-100 bg-white/96 px-2.5 py-1.5 shadow-[0_12px_22px_rgba(21,128,61,0.12)] sm:left-3 sm:gap-2 sm:px-3 sm:py-2",
				children: [/* @__PURE__ */ jsx(SecondaryIcon, {
					className: "size-4 text-emerald-600 sm:size-4.5",
					strokeWidth: 2.1
				}), /* @__PURE__ */ jsx("span", {
					className: "text-[0.66rem] font-bold uppercase tracking-[0.14em] text-emerald-700 sm:text-[0.7rem]",
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: OTHER_SERVICES$1.map((service) => /* @__PURE__ */ jsxs("article", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: OTHER_SERVICES$1.map((service, index) => /* @__PURE__ */ jsx("button", {
								type: "button",
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("button", {
										...
										children: [/* @__PURE__ */ jsx(Phone, { className: "size-6 text-[#586279]" }), CONTACTS.phone]
									})]
								})
							]
						}), /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(SectionIntro$1, {
							...
							children: INDICATIONS$1.map((item) => /* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(SectionHeader$1, {
								...
								className: "mt-8 space-y-4",
								children: PROCESS_STEPS$1.map((step, index) => /* @__PURE__ */ jsxs("li", {
									className: "flex gap-4 rounded-2xl bg-white p-4 shadow-sm",
									children: [/* @__PURE__ */ jsx("span", {
										className: "flex size-9 shrink-0 items-center justify-center rounded-full bg-primary text-sm font-extrabold text-white",
										children: index + 1
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", { children: [
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsx(Container$1, { children: /* @__PURE__ */ jsxs("div", {
						className: "grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16",
						children: [/* @__PURE__ */ jsxs("div", { children: [
							/* @__PURE__ */ jsx("h2", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs(Container$1, { children: [/* @__PURE__ */ jsx(SectionIntro, {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs(Container$1, { children: [/* @__PURE__ */ jsx(SectionIntro, {
						...
						children: METHODS$1.map((item) => /* @__PURE__ */ jsxs("article", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsx(Container$1, { children: /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/post-infarction-rehab-page.tsx
var ANCHORS = [
	{
		href: "#about",
		label: "Про інфаркт"
...
function PostInfarctionRehabPage({ node }) {
	...
	const otherServicesTrackRef = React.useRef(null);
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[linear-gradient(90deg,rgba(8,23,58,0.96)_0%,rgba(8,23,58,0.88)_34%,rgba(8,23,58,0.54)_62%,rgba(8,23,58,0.1)_100%)]" }),
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("button", {
												...
												children: ["Замовити консультацію", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
											})
										]
									})
								})
					...
					/* @__PURE__ */ jsx("section", {
						className: "bg-white",
						children: /* @__PURE__ */ jsxs(Container, { children: [/* @__PURE__ */ jsx(Breadcrumbs, {
							items: [
								{
									title: "Головна",
									route: "/"
							...
							children: /* @__PURE__ */ jsx("nav", {
								...
								children: ANCHORS.map((item, index) => /* @__PURE__ */ jsx("a", {
									href: item.href,
						...
						children: /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									/* @__PURE__ */ jsx("ul", {
										className: "mt-6 space-y-3",
										children: ABOUT_POINTS.map((item) => /* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3 text-sm text-navy/78",
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "mt-0.5 size-5 shrink-0 text-primary" }), /* @__PURE__ */ jsx("span", { children: item })]
										}, item))
									})
								] })]
							}), /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Info, { className: "mt-0.5 size-5 shrink-0" }), /* @__PURE__ */ jsx("p", { children: "Реабілітація допомагає поступово відновлювати активність та формувати безпечний маршрут повернення до повсякденного життя." })]
							})]
						}) })
					}),
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs(Container, { children: [
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx(CalendarCheck2, { className: "size-6" }), /* @__PURE__ */ jsx("h3", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(ShieldAlert, { className: "size-6" }), /* @__PURE__ */ jsx("h3", {
									...
									children: EMERGENCY_SIGNS.map((item) => /* @__PURE__ */ jsxs("li", {
										className: "flex gap-3 text-sm text-red-500/90",
										children: [/* @__PURE__ */ jsx("span", { className: "mt-2 size-1.5 shrink-0 rounded-full bg-red-400" }), /* @__PURE__ */ jsx("span", { children: item })]
									}, item))
								})]
							})
						] })
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs(Container, { children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: SITUATIONS.map((item) => /* @__PURE__ */ jsxs("article", {
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: PROCESS_STEPS.map((step, index) => {
										...
										return /* @__PURE__ */ jsxs("article", {
											...
											children: [
												index < PROCESS_STEPS.length - 1 && /* @__PURE__ */ jsx("span", {
													className: "absolute right-[-14px] top-1/2 hidden -translate-y-1/2 text-primary/40 xl:block",
													children: /* @__PURE__ */ jsx(ArrowRight, { className: "size-6" })
												}),
												/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsx("section", {
						id: "methods",
						className: "bg-white py-6 sm:py-10",
						children: /* @__PURE__ */ jsxs(Container, { children: [/* @__PURE__ */ jsx(SectionTitle, {
							...
							children: [METHODS.map((item) => /* @__PURE__ */ jsxs("article", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("span", {
										...
										children: ["Перейти далі", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
									})
								]
							}, item.title)), /* @__PURE__ */ jsxs("article", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "size-6" }), /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs(Container, {
							...
							children: [
								...
								(node.faq?.length ?? 0) > 3 && /* @__PURE__ */ jsx("div", {
									className: "mt-6 flex justify-center",
									children: /* @__PURE__ */ jsxs("button", {
										type: "button",
										onClick: () => setFaqExpanded((value) => !value),
										...
										children: [faqExpanded ? "Показати менше питань" : "Показати більше питань", /* @__PURE__ */ jsx(ChevronDown, { className: cn("size-4 transition-transform", faqExpanded && "rotate-180") })]
									})
								})
							]
						})
						...
						children: /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: OTHER_SERVICES.map((item) => /* @__PURE__ */ jsxs("article", {
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: OTHER_SERVICES.map((item, index) => /* @__PURE__ */ jsx("button", {
										type: "button",
						...
						children: /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(HeartPulse, { className: "size-8" })
								...
								onClick: () => openModal("Записатися на консультацію"),
								className: "inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl bg-brand-green px-7 py-4 text-sm font-bold text-brand-green-foreground transition-colors hover:bg-brand-green/90",
								children: ["Записатися на консультацію", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
							})]
						}) })
					})
				]
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: items.map((item) => /* @__PURE__ */ jsxs("li", {
				...
				children: [/* @__PURE__ */ jsx("span", { className: cn("mt-2 size-1.5 shrink-0 rounded-full bg-primary", bulletClassName) }), /* @__PURE__ */ jsx("span", { children: item })]
			}, item))
		})]
	});
}
...
function NodePage() {
	...
	if (node.customPage === "post-infarction-rehab") return /* @__PURE__ */ jsx(PostInfarctionRehabPage, { node });
