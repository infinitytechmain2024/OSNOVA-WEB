import { a as SiteHeader, d as cpet_test_default, f as service_sports_default, l as ergometer_default, m as service_rehab_default, p as service_checkup_default, t as SiteFooter, u as ecg_review_default, y as AppLink } from "./site-footer-DtdGqSzK.js";
...
import { ArrowRight, CalendarDays, ChevronLeft, ChevronRight, Clock3, GraduationCap, MapPin, Stethoscope, Users } from "lucide-react";
//#region src/components/education-courses-page.tsx
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-navy-deep/75 via-navy-deep/10 to-transparent" }),
				/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx(CalendarDays, { className: "size-3.5" }), course.date]
				})
			]
		}), /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(GraduationCap, { className: "size-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: course.format })]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Clock3, { className: "size-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: course.duration })]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Users, { className: "size-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: course.audience })]
						})
					]
				}),
...
function EducationCoursesPage({ title = "Навчання" }) {
	...
	const courseGridRef = React.useRef(null);
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("a", {
										...
										children: ["ПЕРЕГЛЯНУТИ КУРСИ ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
					...
					children: /* @__PURE__ */ jsx(PageContainer, { children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: visibleCourses.map((course) => /* @__PURE__ */ jsx(CourseCard, { course }, `${course.title}-${course.date}`))
							}),
							/* @__PURE__ */ jsxs("nav", {
