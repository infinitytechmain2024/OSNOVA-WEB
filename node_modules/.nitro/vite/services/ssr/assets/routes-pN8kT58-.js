import { C as cn, S as useConsultationModal, _ as service_sports_default, a as SiteFooter, g as cpet_test_default, h as ecg_review_default, l as SiteHeader, m as ergometer_default, t as Breadcrumbs, v as service_checkup_default, w as AppLink, y as service_rehab_default } from "./blocks-qW3lZTX0.js";
...
import { t as NEWS_ARTICLES } from "./news-Bg28w2cq.js";
...
function Index() {
	...
	const [cooperationStepHeight, setCooperationStepHeight] = React.useState(0);
	const cooperationStackRef = React.useRef(null);
	...
	const handleCooperationTransitionEnd = React.useCallback((e) => {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("h2", {
										...
										children: ["ОСНОВА ", /* @__PURE__ */ jsx("span", {
											className: "text-[#215FBC]",
											children: "Реабілітація"
										})]
									}),
									/* @__PURE__ */ jsx("div", { className: "mb-8 h-[4px] w-20 rounded-full bg-gradient-to-r from-[#215FBC] via-[#215FBC] 50% to-[#10b981]" }),
									/* @__PURE__ */ jsxs("div", {
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsxs(AppLink, {
											...
											children: ["ДЕТАЛЬНІШЕ ", /* @__PURE__ */ jsx(ChevronRight, { className: "h-4.5 w-4.5 stroke-[2.5]" })]
										})
									})
								]
							}), /* @__PURE__ */ jsx("div", {
