import { _ as useConsultationModal, a as SiteHeader, c as siteTree, d as cpet_test_default, f as service_sports_default, h as ConsultationForm, i as getNodeByRoute, l as ergometer_default, m as service_rehab_default, n as getBreadcrumbs, o as CONTACTS, p as service_checkup_default, s as IMAGES, t as SiteFooter, u as ecg_review_default, v as cn, y as AppLink } from "./site-footer-DtdGqSzK.js";
import { a as WhenToPassCardioRehabBlock, i as SectionHeader$1, n as FAQAccordion, r as PageContainer, t as Breadcrumbs } from "./blocks-x0lAFLuX.js";
import { t as Route$1 } from "./_-D29xQd0O.js";
import { n as getServicePageData, r as OtherServices, t as ServiceDetailTemplate } from "./service-detail-template-CQaoChX0.js";
import { n as education_conference_default, t as education_training_default } from "./education-training-D0E3Ecw7.js";
import { a as partner_heart_default, i as partner_ifnmu_default, n as partner_sytenko_default, o as partner_chnu_default, r as partner_karpatska_akademiia_default, s as partner_asmu_default, t as osnova_logo_3d_default } from "./osnova-logo-3d-DbG2o_rZ.js";
import * as React from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Activity, AlertTriangle, Ambulance, ArrowRight, BadgeCheck, BookOpen, Building2, CalendarDays, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardCheck, ClipboardList, Clock, Dumbbell, ExternalLink, FileText, FlaskConical, GraduationCap, Handshake, Heart, HeartPulse, Home, Layers, Mail, MapPin, MapPinned, MessageCircle, MessageSquare, Microscope, Navigation, Package, Phone, PhoneCall, Presentation, Route, Search, Send, Share2, ShieldCheck, Sparkles, Stethoscope, Truck, UploadCloud, UserRoundCheck, Users, Wrench } from "lucide-react";
															...
															children: [
																...
																/* @__PURE__ */ jsx("td", {
																	...
																	children: /* @__PURE__ */ jsxs(AppLink, {
																		...
																		children: ["Перейти ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-3.5" })]
																	})
																})
															]
														}, item.id))
													...
													children: [
														...
														/* @__PURE__ */ jsxs("div", {
															...
															children: [/* @__PURE__ */ jsxs("div", {
																...
																children: ["Перейти ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-3" })]
															})]
														})
													]
												}, item.id))
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", { children: [
				...
				/* @__PURE__ */ jsx(PageSection, {
					...
					children: /* @__PURE__ */ jsx(WhenToPassCardioRehabBlock, {
				...
				/* @__PURE__ */ jsx(PageSection, {
					...
					children: /* @__PURE__ */ jsx(TimingSection, {})
				}),
				/* @__PURE__ */ jsx("section", {
					id: "for-whom",
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: PROCESS_STEPS$1.map((step, index) => /* @__PURE__ */ jsxs("article", {
								className: "relative rounded-2xl border border-background/12 bg-background/8 p-5 lg:min-h-[250px]",
								children: [
									index < PROCESS_STEPS$1.length - 1 && /* @__PURE__ */ jsx("span", { className: "absolute left-[calc(100%-10px)] top-10 hidden h-px w-8 bg-background/24 lg:block" }),
									/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsx(DocumentsReviewSection, {}),
				faqItems.length > 0 && /* @__PURE__ */ jsxs(PageSection, {
					id: "faq",
					...
					}), /* @__PURE__ */ jsx(FAQAccordion, { items: faqItems })]
				}),
				/* @__PURE__ */ jsx(PageSection, {
				...
				return /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsx(Icon, { className: cn("size-5", column.iconColor) })
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: DOCUMENT_STEPS.map((step, index) => /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("form", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("button", {
								...
								children: [
									/* @__PURE__ */ jsx(UploadCloud, { className: "size-9 text-primary" }),
									/* @__PURE__ */ jsx("span", {
							...
							files.length > 0 && /* @__PURE__ */ jsx("ul", {
								...
								children: files.map((file) => /* @__PURE__ */ jsxs("li", {
									...
									children: [/* @__PURE__ */ jsx(FileText, { className: "size-4 shrink-0 text-primary" }), /* @__PURE__ */ jsx("span", {
										className: "truncate",
										children: file
									})]
								}, file))
			...
			/* @__PURE__ */ jsxs("main", { children: [
					...
					children: /* @__PURE__ */ jsxs(PageContainer, { children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "mx-auto mt-5 h-1 w-16 rounded-full bg-primary" }),
								/* @__PURE__ */ jsx("p", {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsx(MapPin, { className: "size-7" })
											}),
											/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs(PageContainer, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsx(FAQAccordion, { items: [
							{
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("button", {
									...
									children: ["Надіслати документи", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4 transition-transform group-hover:translate-x-1" })]
								})]
							})
						] }), /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-5 -z-0 rounded-[38px] bg-primary/8 blur-2xl" }), /* @__PURE__ */ jsx("div", {
