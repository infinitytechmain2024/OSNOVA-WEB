import { a as SiteHeader, d as cpet_test_default, f as service_sports_default, i as getNodeByRoute, m as service_rehab_default, n as getBreadcrumbs, o as CONTACTS, t as SiteFooter, y as AppLink } from "./site-footer-DtdGqSzK.js";
import { i as SectionHeader, r as PageContainer, t as Breadcrumbs } from "./blocks-Lh4po0e0.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { Activity, ArrowRight, Building2, CalendarDays, CheckCircle2, Clock3, Dumbbell, GraduationCap, HeartPulse, MapPin, MessageCircle, Users } from "lucide-react";
//#region src/routes/iventy.tsx?tsr-split=component
var venueCards = [{
	icon: Dumbbell,
	title: "Фітнес-зал",
	label: "рухові події",
			...
			/* @__PURE__ */ jsxs("main", { children: [
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-navy-deep via-navy-deep/88 to-navy-deep/30" }),
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs(AppLink, {
											...
											children: [/* @__PURE__ */ jsx(MessageCircle, { className: "size-4" }), "Запитати про найближчий івент"]
										}), /* @__PURE__ */ jsxs("a", {
											...
											children: [/* @__PURE__ */ jsx(CalendarDays, { className: "size-4" }), CONTACTS.phone]
										})]
									})
								]
							}), /* @__PURE__ */ jsx("dl", {
				...
				/* @__PURE__ */ jsxs(PageContainer, {
					...
					children: [/* @__PURE__ */ jsx(SectionHeader, {
						...
						children: venueCards.map((venue) => /* @__PURE__ */ jsxs("article", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: /* @__PURE__ */ jsx(venue.icon, {
										className: "size-6",
										"aria-hidden": true
									})
								...
								children: venue.bullets.map((bullet) => /* @__PURE__ */ jsxs("li", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs(PageContainer, { children: [/* @__PURE__ */ jsx(SectionHeader, {
						...
						children: events.map((event) => /* @__PURE__ */ jsxs("article", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("span", {
											...
											children: [/* @__PURE__ */ jsx(event.icon, {
												className: "size-3.5",
												"aria-hidden": true
											}), event.tag]
										}), /* @__PURE__ */ jsxs("span", {
									...
									/* @__PURE__ */ jsxs(AppLink, {
										...
										children: ["Дізнатися про участь ", /* @__PURE__ */ jsx(ArrowRight, {
											className: "size-4",
											"aria-hidden": true
										})]
									})
				...
				/* @__PURE__ */ jsx(PageContainer, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(SectionHeader, {
							...
							children: formats.map((format) => /* @__PURE__ */ jsxs("div", {
