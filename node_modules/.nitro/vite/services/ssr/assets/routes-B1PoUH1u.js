import { C as cn, S as useConsultationModal, _ as service_sports_default, a as SiteFooter, g as cpet_test_default, h as ecg_review_default, l as SiteHeader, m as ergometer_default, t as Breadcrumbs, v as service_checkup_default, w as AppLink, y as service_rehab_default } from "./blocks-CcgCGD_9.js";
...
import { t as NEWS_ARTICLES } from "./news-oORjDLlC.js";
...
function CooperationCard({ item, index, isActive = false, isNext = false, onClick }) {
	...
	if (isNext) return /* @__PURE__ */ jsx("button", {
		onClick,
		type: "button",
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "mb-7 h-[4px] w-20 rounded-full bg-gradient-to-r from-[#1d63ed] via-[#1d63ed] 50% to-[#10b981]" }),
									/* @__PURE__ */ jsxs("div", {
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsxs(AppLink, {
											...
											children: ["ДЕТАЛЬНІШЕ ", /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 stroke-[2.5]" })]
										})
									})
								]
							}), /* @__PURE__ */ jsxs("div", {
