...
import { ArrowLeft, ArrowRight, BookOpen, Brain, Calendar, ChevronDown, ChevronRight, ClipboardList, Dumbbell, Flame, GraduationCap, Heart, Microscope, Network, Phone, ShieldCheck, Stethoscope, Trophy, UserCheck, Users, Zap } from "lucide-react";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", { children: [
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "absolute -left-[10%] top-[20%] size-[500px] rounded-full bg-primary/5 blur-[120px]" }), /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx(SectionHeader, {
									...
									title: /* @__PURE__ */ jsxs(Fragment, { children: ["ОСНОВА ", /* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", { children: "ОСНОВА Реабілітація допомагає відновити здоров'я, рух та якість життя після захворювань, травм та операцій." }), /* @__PURE__ */ jsx("p", { children: "Ми використовуємо сучасні методи діагностики, персональні програми відновлення та комплексний підхід під контролем спеціалістів." })]
								}),
								/* @__PURE__ */ jsx("div", {
									className: "mt-10",
									children: /* @__PURE__ */ jsxs(AppLink, {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(SectionHeader, {
							...
							children: COOPERATION_ITEMS.map((item) => /* @__PURE__ */ jsx(CooperationCard, { item }, item.number))
						})]
					})
				}),
				/* @__PURE__ */ jsx("section", {
