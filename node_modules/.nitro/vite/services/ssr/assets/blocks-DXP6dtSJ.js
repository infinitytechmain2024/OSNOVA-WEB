...
import { ArrowRight, ArrowUp, Check, CheckCircle2, ChevronDown, ChevronRight, Circle, Clock, Facebook, Home, Instagram, Languages, Loader2, Mail, MapPin, Menu, MessageSquare, Music2, Phone, PhoneCall, Send, ShieldCheck, Sparkles, User, X, Youtube } from "lucide-react";
import { clsx } from "clsx";
import { twMerge } from "tailwind-merge";
import * as DialogPrimitive from "@radix-ui/react-dialog";
import * as DropdownMenuPrimitive from "@radix-ui/react-dropdown-menu";
//#region src/components/app-link.tsx
...
//#endregion
//#region src/components/consultation-form.tsx
function ConsultationForm({ title = "Записатися на консультацію", subtitle = "Заповніть форму нижче, і наш адміністратор зв'яжеться з вами для уточнення деталей.", className, onSuccess, compact = false, tone = "light", showPrivacyConsent = true }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: cn("pointer-events-none absolute -right-16 -top-16 size-48 rounded-full blur-3xl opacity-20", isDark ? "bg-brand-green" : "bg-primary") }), isSubmitted ? /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-10 animate-in zoom-in duration-300" }), /* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(Sparkles, { className: "size-3" })
					})]
				}),
				/* @__PURE__ */ jsx("h3", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("p", {
						...
						children: [/* @__PURE__ */ jsx(PhoneCall, { className: "size-5 shrink-0 text-emerald-600 dark:text-emerald-400 animate-bounce" }), /* @__PURE__ */ jsx("span", { children: "Ваше повідомлення відправлено, очікуйте дзвінка від адміністратора." })]
					})
				}),
				/* @__PURE__ */ jsx("p", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("label", {
						...
						children: ["Ім'я ", /* @__PURE__ */ jsx("span", {
							className: "text-destructive",
							children: "*"
						})]
					}), /* @__PURE__ */ jsxs("div", {
						className: "relative",
						children: [/* @__PURE__ */ jsx(User, { className: "absolute left-3.5 top-1/2 size-4 -translate-y-1/2 text-emerald-700/60 dark:text-emerald-400/60 pointer-events-none" }), /* @__PURE__ */ jsx("input", {
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("label", {
						...
						className: cn("block text-xs font-bold uppercase tracking-wider mb-1.5", isDark ? "text-background/90" : "text-navy/90"),
						children: ["Номер телефону ", /* @__PURE__ */ jsx("span", {
							className: "text-destructive",
							children: "*"
						})]
					}), /* @__PURE__ */ jsxs("div", {
						className: "relative",
						children: [/* @__PURE__ */ jsx(Phone, { className: "absolute left-3.5 top-1/2 size-4 -translate-y-1/2 text-emerald-700/60 dark:text-emerald-400/60 pointer-events-none" }), /* @__PURE__ */ jsx("input", {
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						...
						className: "relative",
						children: [/* @__PURE__ */ jsx(MessageSquare, { className: "absolute left-3.5 top-3.5 size-4 text-emerald-700/60 dark:text-emerald-400/60 pointer-events-none" }), /* @__PURE__ */ jsx("textarea", {
					...
					/* @__PURE__ */ jsx("button", {
						...
						children: isSubmitting ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }), /* @__PURE__ */ jsx("span", { children: "Надіслати запит..." })] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Send, { className: "size-4 transition-transform group-hover:translate-x-0.5" }), /* @__PURE__ */ jsx("span", { children: "Надіслати запит" })] })
					})
				]
			})] }), showPrivacyConsent && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("p", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "size-3.5 text-emerald-600 dark:text-emerald-400 shrink-0" }), " Конфіденційність гарантовано"]
					}), /* @__PURE__ */ jsxs("span", {
						className: "inline-flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx(Clock, { className: "size-3.5 text-emerald-600 dark:text-emerald-400 shrink-0" }), " Відповідь протягом 15 хв"]
					})]
				})]
			})]
		})]
	...
	return /* @__PURE__ */ jsx(Dialog, {
		...
		children: /* @__PURE__ */ jsxs(DialogContent, {
			...
			children: [/* @__PURE__ */ jsxs(DialogHeader, {
				className: "sr-only",
				children: [/* @__PURE__ */ jsx(DialogTitle, { children: title }), /* @__PURE__ */ jsx(DialogDescription, { children: "Форма запису на консультацію в клініку Основа" })]
...
*/
var ConsultationModalContext = React.createContext({
	isOpen: false,
	openModal: () => {},
	closeModal: () => {}
});
function ConsultationModalProvider({ children }) {
	...
	const openModal = React.useCallback((title) => {
	...
	return /* @__PURE__ */ jsxs(ConsultationModalContext.Provider, {
		value: {
			isOpen,
			openModal,
			closeModal
		},
		children: [children, /* @__PURE__ */ jsx(ConsultationModal, {
			open: isOpen,
...
function LanguageSelect({ value, onValueChange, className, tone = "dark" }) {
	...
	return /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
		...
		children: /* @__PURE__ */ jsxs("button", {
			...
			children: [
				/* @__PURE__ */ jsx(Languages, { className: "size-4 opacity-85" }),
				/* @__PURE__ */ jsx("span", { children: currentLang.shortLabel }),
				/* @__PURE__ */ jsx(ChevronDown, { className: "size-3.5 opacity-80" })
			]
		})
		...
		children: /* @__PURE__ */ jsx(DropdownMenuRadioGroup, {
			...
			children: LANGS.map((lang) => /* @__PURE__ */ jsx(DropdownMenuRadioItem, {
				value: lang.value,
				...
				children: /* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: lang.label }), /* @__PURE__ */ jsx("span", {
...
function DesktopNavItem({ item }) {
	const [isOpen, setIsOpen] = React.useState(false);
	const [activeChildId, setActiveChildId] = React.useState(null);
	...
	return /* @__PURE__ */ jsxs("li", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs(AppLink, {
				...
				children: [item.label, hasChildren && /* @__PURE__ */ jsx(ChevronDown, { className: "size-3.5 opacity-70 group-hover:rotate-180 transition-transform duration-200" })]
			})
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("ul", {
					...
					children: item.children.map((child) => {
						...
						return /* @__PURE__ */ jsx("li", {
							...
							children: /* @__PURE__ */ jsxs(AppLink, {
								...
								}), childHasChildren && /* @__PURE__ */ jsx(ChevronRight, { className: "size-3.5 shrink-0 opacity-70 text-primary-foreground" })]
							})
						}, child.id);
					})
				}), hasLevel2 && activeChild && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						children: activeChild.children.map((sub) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(AppLink, {
							to: sub.route,
							onClick: () => setIsOpen(false),
...
function MobileNavItem({ item, onClose }) {
	...
	const [expandedChildId, setExpandedChildId] = React.useState(null);
	const hasChildren = item.children && item.children.length > 0;
	return /* @__PURE__ */ jsxs("li", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(AppLink, {
				...
				children: /* @__PURE__ */ jsx(ChevronDown, { className: cn("size-4 transition-transform", expanded && "rotate-180") })
			})]
		}), expanded && hasChildren && /* @__PURE__ */ jsx("ul", {
			...
			children: item.children.map((child) => {
				...
				return /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(AppLink, {
						...
						children: child.title
					}), childHasChildren && /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => setExpandedChildId((curr) => curr === child.id ? null : child.id),
						className: "p-1 text-navy/60",
						children: /* @__PURE__ */ jsx(ChevronDown, { className: cn("size-3.5 transition-transform", isChildExpanded && "rotate-180") })
					})]
				}), isChildExpanded && childHasChildren && /* @__PURE__ */ jsx("ul", {
					className: "pl-3 py-1 space-y-1.5 border-l border-border/60 ml-1",
					children: child.children.map((sub) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(AppLink, {
						to: sub.route,
						onClick: onClose,
...
function SiteHeader() {
	...
	const [language, setLanguage] = React.useState("uk");
		...
		children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: SOCIALS$1.map((Icon, i) => /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx("nav", {
				...
				children: /* @__PURE__ */ jsx("ul", {
					...
					children: HEADER_NAV.map((item) => /* @__PURE__ */ jsx(DesktopNavItem, { item }, item.label))
				})
			}),
			menuOpen && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("ul", {
					...
					children: [
						...
						HEADER_NAV.map((item) => /* @__PURE__ */ jsx(MobileNavItem, {
							item,
						...
						/* @__PURE__ */ jsxs("li", {
							...
							children: [
								/* @__PURE__ */ jsxs("a", {
									...
									children: [
										/* @__PURE__ */ jsx(Phone, { className: "size-4 text-primary" }),
										" ",
										CONTACTS.phone
									]
								}),
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(MapPin, { className: "size-3.5 text-primary shrink-0" }), /* @__PURE__ */ jsx("span", {
										className: "truncate",
...
function LinkColumn({ title, items, allRoute, allLabel = "Усі послуги" }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "mt-3 h-px w-full bg-background/15" }),
			/* @__PURE__ */ jsx("ul", {
				className: "mt-5 flex-1 space-y-3",
				children: items.map((i) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(AppLink, {
					to: i.route,
					className: "group flex items-start gap-2 text-sm leading-snug text-background/70 transition-colors hover:text-background",
					children: [/* @__PURE__ */ jsx(ChevronRight, { className: "mt-0.5 size-4 shrink-0 text-background/40 transition-colors group-hover:text-primary-foreground" }), /* @__PURE__ */ jsx("span", { children: i.title })]
				}) }, i.route))
			}),
			/* @__PURE__ */ jsxs(AppLink, {
				to: allRoute,
				...
				children: [allLabel, /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
			})
		]
	});
}
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "mt-6 h-px w-full max-w-[15rem] bg-background/15" }),
							/* @__PURE__ */ jsxs("ul", {
								className: "mt-5 space-y-2 text-sm text-background/70",
								children: [
									/* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(AppLink, {
										to: about.route,
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("ul", {
									...
									children: [
										/* @__PURE__ */ jsxs("li", {
											...
											children: [/* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 size-4 shrink-0 text-primary-foreground/80" }), /* @__PURE__ */ jsx("span", { children: CONTACTS.addressFull })]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3",
											children: [/* @__PURE__ */ jsx(Phone, { className: "mt-0.5 size-4 shrink-0 text-brand-green" }), /* @__PURE__ */ jsx("a", {
												href: CONTACTS.phoneHref,
										...
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3",
											children: [/* @__PURE__ */ jsx(Mail, { className: "mt-0.5 size-4 shrink-0 text-primary-foreground/80" }), /* @__PURE__ */ jsx("a", {
										...
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3",
											children: [/* @__PURE__ */ jsx(Clock, { className: "mt-0.5 size-4 shrink-0 text-primary-foreground/80" }), /* @__PURE__ */ jsxs("span", { children: [
												"Зал: ",
												CONTACTS.gymHours,
												/* @__PURE__ */ jsx("br", {}),
												"Реабілітація: ",
								...
								/* @__PURE__ */ jsxs("a", {
									...
									children: [
										/* @__PURE__ */ jsx(Send, { className: "size-4 text-primary-foreground/80" }),
										" ",
										CONTACTS.messengers.telegramHandle
									]
								}),
								/* @__PURE__ */ jsx("div", { className: "mt-6 h-px w-full bg-background/15" }),
								/* @__PURE__ */ jsx(AppLink, {
									to: "/kontakty",
...
//#endregion
//#region src/components/blocks.tsx
...
function SectionHeader({ eyebrow, eyebrowClassName, title, text }) {
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsx("div", { className: "mt-4 sm:mt-6 h-1 w-16 rounded-full bg-primary" }),
		text && /* @__PURE__ */ jsx("p", {
		...
		children: /* @__PURE__ */ jsx("ol", {
			...
			children: items.map((item, i) => /* @__PURE__ */ jsxs("li", {
				...
				children: [i > 0 && /* @__PURE__ */ jsx("span", {
					...
					children: i === 0 ? /* @__PURE__ */ jsxs("span", {
...
function FAQAccordion({ items, variant = "default" }) {
	...
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("script", {
		...
		children: items.map((item, i) => {
			...
			return /* @__PURE__ */ jsxs("li", {
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					}), /* @__PURE__ */ jsx(ChevronDown, { className: cn(variant === "home" ? "size-5 shrink-0 text-muted-foreground transition-transform duration-300" : "size-5 shrink-0 text-primary transition-transform duration-200", isOpen && "rotate-180") })]
				}), /* @__PURE__ */ jsx("div", {
					id: panelId,
					hidden: !isOpen,
...
//#endregion
export { Dialog as C, DialogTitle as D, DialogHeader as E, cn as O, useConsultationModal as S, DialogDescription as T, service_sports_default as _, SiteFooter as a, ConsultationForm as b, getNodeByRoute as c, IMAGES as d, siteTree as f, cpet_test_default as g, ecg_review_default as h, SectionHeader as i, AppLink as k, SiteHeader as l, ergometer_default as m, FAQAccordion as n, getBreadcrumbs as o, CARDIO_REHAB_PROGRAMS as p, PageContainer as r, getNodeById as s, Breadcrumbs as t, CONTACTS as u, service_checkup_default as v, DialogContent as w, ConsultationModalProvider as x, service_rehab_default as y };
