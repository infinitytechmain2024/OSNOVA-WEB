...
const HERO_SLIDES = [
  {
    image: rehabImg,
    title: "Верніться до активного життя",
    subtitle: "Реабілітація",
    text: "Персональна програма реабілітації після захворювань, травм та операцій. Оцінюємо ваш стан, визначаємо можливості організму та створюємо індивідуальний план відновлення під ваші цілі.",
    ctaLabel: "Записатися на реабілітацію",
  },
  {
    image: cpetImg,
    title: "Відновлення серця під контролем спеціалістів",
    subtitle: "Кардіологія",
    text: "Кардіологічна діагностика та безпечне повернення до навантажень. Проводимо діагностику серцево-судинної системи та підбираємо рівень фізичної активності на основі стану пацієнта.",
    ctaLabel: "Пройти діагностику",
  },
  {
    image: sportsImg,
    title: "Тренуйтеся ефективніше та безпечніше",
    subtitle: "Спортивна медицина",
    text: "Діагностика фізичного стану та персональний спортивний контроль. Оцінюємо витривалість, функціональні можливості організму та допомагаємо досягати цілей без ризику для здоров'я.",
    ctaLabel: "Записатися на консультацію",
  },
  {
    image: checkupImg,
    title: "Дізнайтеся більше про стан свого здоров'я",
    subtitle: "Чекап",
    text: "Комплексна діагностика організму та рекомендації спеціалістів. Допомагаємо виявити можливі ризики, оцінити стан організму та визначити подальші кроки.",
