            ...
            <div className="grid items-center gap-16 lg:grid-cols-2">
              <div>
                <SectionHeader
                  ...
                  title={
                    <>
                      Напрями <span className="text-primary">реабілітації та лікування</span>
                    </>
                  }
                />
                ...
                <div className="space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed">
                  <p className="font-medium text-navy text-xl leading-relaxed">
                    У центрі проводиться комплексна реабілітація після захворювань, травм,
                    операцій і тривалого обмеження рухливості. Основні напрями роботи охоплюють
                    кардіологічну, ортопедичну, травматологічну, неврологічну, ревматологічну
                    та вертебрологічну реабілітацію.
                  </p>
                  <p>
                    Пацієнти можуть проходити відновлення після інфаркту міокарда, операцій
                    на серці, ендопротезування суглобів, переломів, спортивних травм,
                    захворювань хребта, інсульту та інших станів, що впливають на рухливість,
                    витривалість і якість життя.
                  </p>
                </div>
