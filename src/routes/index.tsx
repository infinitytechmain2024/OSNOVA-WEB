...
const HERO_SLIDES = [
  {
    image: rehabImg,
    title: "Реабілітація",
    subtitle: "Верніться до активного життя після захворювань, операцій та травм",
    text: "Ваше індивідуальне відновлення з персональною програмою реабілітації, підібраною з урахуванням вашого стану, можливостей та цілей відновлення.",
    ctaLabel: "Записатися на реабілітацію",
  },
  {
    image: cpetImg,
    title: "Кардіореабілітація",
    subtitle: "Безпечне відновлення серця та повернення до звичної активності",
    text: "Розробляємо індивідуальну програму відновлення після серцево-судинних захворювань та операцій під контролем спеціалістів.",
    ctaLabel: "Записатися на кардіореабілітацію",
  },
  {
    image: ecgImg,
    title: "Діагностика",
    subtitle: "Зрозумійте стан свого здоров'я та отримайте правильний план дій",
    text: "Проводимо комплексну оцінку організму, щоб визначити можливості, ризики та підібрати ефективну програму відновлення.",
    ctaLabel: "Записатися на діагностику",
  },
  {
    image: checkupImg,
    title: "Чекап здоров'я",
    subtitle: "Контролюйте здоров'я до появи серйозних проблем",
    text: "Комплексне обстеження допомагає оцінити стан організму, виявити ризики та отримати рекомендації спеціалістів.",
    ctaLabel: "Обрати чекап",
  },
  {
    image: sportsImg,
    title: "Спортивна медицина",
    subtitle: "Тренуйтеся ефективніше, безпечніше та з розумінням можливостей організму",
    text: "Оцінюємо фізичну підготовку, витривалість та реакцію організму на навантаження для досягнення ваших цілей.",
