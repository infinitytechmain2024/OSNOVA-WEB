            ...
            <div className="grid items-center gap-16 lg:grid-cols-2">
              <div>
                <SectionHeader
                  ...
                  title={
                    <>
                      Напрями <span className="text-primary">та методики</span>
                    </>
                  }
                />
                ...
                <div className="space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed">
                  <p className="font-medium text-navy text-xl leading-relaxed">
                    ОСНОВА Реабілітація охоплює повний спектр напрямків відновлення — від
                    кардіології та ортопедії до неврології та спортивної медицини.
                  </p>
                  <p>
                    Наші спеціалісти працюють з пацієнтами після інфарктів, інсультів, травм
                    хребта та суглобів, операцій на ендопротезування, а також при хронічних
                    болях та ревматичних захворюваннях.
                  </p>
                  <p className="font-semibold text-primary">
                    Ми поєднуємо фізичну терапію, апаратні методики, ерготерапію та
                    психологічну підтримку в єдину програму відновлення.
                  </p>
                  <p>
                    Кожна програма індивідуальна: ми враховуємо діагноз, вік, рівень активності
                    та цілі пацієнта. Використовуємо доказові протоколи та сучасне обладнання
