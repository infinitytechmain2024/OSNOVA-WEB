...
const COURSES: Course[] = [
  {
    ...
    description:
      "Алгоритми оцінки ризиків, дозування навантаження та побудова безпечного плану відновлення.",
    image: cpetImg,
  },
  {
    ...
    description:
      "Огляд післяопераційних протоколів, тестування функції та прогресія вправ у різні етапи відновлення.",
    image: rehabImg,
  },
  {
    ...
    description:
      "Інтерпретація кардіопульмонального тестування для оцінки витривалості та безпеки тренувань.",
    image: cpetImg,
  },
  {
    ...
    description:
      "Побудова маршруту пацієнта після інсульту: цілі, оцінка руху, домашні рекомендації та контроль динаміки.",
  ...
  },
  {
    ...
    description:
      "Клінічні тести, шкали та прості рішення для документування прогресу пацієнта під час курсу.",
    image: ergoImg,
  },
  {
    ...
    description:
      "Повернення до бігу, залу та командних видів спорту через контроль навантаження і функціональні критерії.",
    image: sportsImg,
  },
  {
    ...
    description:
      "Розбір червоних прапорців, рухових стратегій, ергономіки та безпечної прогресії активності.",
    image: ergoImg,
  },
  {
    ...
    description:
      "Як пояснювати цілі, підтримувати мотивацію та синхронізувати команду під час тривалого відновлення.",
  ...
  },
  {
    ...
    description:
      "Базові ЕКГ-зміни, які важливо враховувати перед стартом фізичного навантаження і під час занять.",
    image: ecgImg,
  },
  {
    ...
    description:
      "Як формувати корисні чек-апи без зайвих обстежень: покази, маршрутизація, висновок і супровід.",
    image: checkupImg,
  },
  {
    ...
    audience: "Фізичні терапевти",
    description:
      "Покази, налаштування режимів, контроль болю та інтеграція механотерапії у загальну програму.",
    image: rehabImg,
  },
  {
    ...
    audience: "Лікарі та терапевти",
    description:
      "Адаптація навантажень при артриті, артрозі та системних станах з урахуванням болю і втоми.",
    image: checkupImg,
  },
  {
    ...
    description:
      "Структура цілей, етапів, контрольних точок та підсумкового висновку для різних клінічних сценаріїв.",
    image: educationTrainingImg,
  },
  {
    ...
    audience: "Фізичні терапевти",
    description:
      "Вправи у воді для пацієнтів після травм, операцій та при обмеженні навантаження на суглоби.",
    image: sportsImg,
  },
  {
    ...
    audience: "Медичні команди",
    description:
      "Практичні інструменти для зниження тривоги, роботи з очікуваннями та підтримки пацієнта в процесі.",
    image: educationConferenceImg,
  },
  {
    ...
    audience: "Терапевти та тренери",
    description:
      "Побудова безпечних силових занять, моніторинг самопочуття та критерії прогресії навантаження.",
    image: sportsImg,
  },
  {
    ...
    audience: "Лікарі",
    description:
      "Як використовувати дані добового моніторингу для оцінки безпеки реабілітаційного навантаження.",
    image: ecgImg,
  },
  {
    ...
    audience: "Фізичні терапевти",
    description:
      "Етапи відновлення після втручань на плечовому суглобі: мобільність, стабільність і повернення функції.",
    image: rehabImg,
  },
  {
    ...
    audience: "Лікарі та терапевти",
    description:
      "Модель мультидисциплінарного розбору випадку: від первинної оцінки до домашнього плану.",
    image: educationConferenceImg,
  },
  {
    ...
    audience: "Фахівці реабілітації",
    description:
      "Прогресія вправ, контроль болю та навчання пацієнта самостійному підтриманню активності.",
    image: ergoImg,
  },
  {
    ...
    audience: "Лікарі та терапевти",
    description:
      "Оцінка толерантності до навантаження, дихальні вправи та поступове повернення до тренувань.",
    image: cpetImg,
  },
  {
    ...
    description:
      "Шаблони цілей, проміжних оцінок, рекомендацій і фінального висновку для прозорої роботи команди.",
    image: educationTrainingImg,
  },
  {
    ...
    audience: "Фізичні терапевти",
    description:
      "Оцінка запаморочення, вправи на стабілізацію погляду та критерії безпечного домашнього плану.",
    image: ergoImg,
  },
  {
    ...
    description:
      "Скринінг ризиків, тестування витривалості та прості правила супроводу активних пацієнтів.",
    image: sportsImg,
  },
  {
    ...
    audience: "Медичні команди",
    description:
      "Баланс, сила, профілактика падінь і робота з супутніми станами у персоналізованій програмі.",
    image: checkupImg,
  },
  {
    ...
    audience: "Фахівці реабілітації",
    description:
      "Оновлення прикладної анатомії через рухові тести, клінічні приклади та вправи для щоденної практики.",
    image: educationTrainingImg,
  },
  {
    ...
    description:
      "Комбінація освіти пацієнта, руху, психологічної підтримки та медичного контролю при хронічному болю.",
    image: educationConferenceImg,
  },
  {
    ...
    audience: "Фізичні терапевти",
    description:
      "Клінічне мислення, комунікація, супервізія та побудова індивідуального плану професійного росту.",
    image: rehabImg,
  },
  {
    ...
    audience: "Лікарі та терапевти",
    description:
      "Оцінка стану, контроль симптомів і поступове підвищення активності у пацієнтів із серцевою недостатністю.",
    image: cpetImg,
  },
  {
    ...
    audience: "Медичні команди",
    description:
      "Як допомагати пацієнтам закріплювати рух, сон, активність і самоспостереження після завершення курсу.",
    image: sportsImg,
  },
  {
    ...
    description:
      "Показники якості, структура процесів, внутрішні чек-листи та прозора оцінка результатів програми.",
    image: educationConferenceImg,
  },
  {
    ...
    description:
      "Знайомство з просторами центру, командною моделлю, діагностикою та реабілітаційними маршрутами.",
    image: educationTrainingImg,
  },
  {
    ...
    description:
      "Формати співпраці з університетами, кафедрами та професійними асоціаціями на базі ОСНОВА.",
    image: educationConferenceImg,
  },
];
...
function CourseCard({ course }: { course: Course }) {
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[24px] border border-slate-200/80 bg-card shadow-lg shadow-slate-900/5 transition-all duration-300 hover:-translate-y-1.5 hover:border-primary/35 hover:shadow-2xl">
      <div className="relative h-56 overflow-hidden bg-slate-100">
        ...
        <span className="absolute left-4 top-4 rounded-full bg-white/95 px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.12em] text-primary shadow-sm">
          {course.category}
        </span>
        <span className="absolute bottom-4 left-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/15 px-3.5 py-1.5 text-xs font-semibold text-white backdrop-blur-md">
      ...
      <div className="flex flex-1 flex-col p-6">
        <h3 className="text-xl font-extrabold leading-snug text-navy transition-colors group-hover:text-primary">
          {course.title}
        </h3>
        <p className="mt-4 flex-1 text-sm leading-relaxed text-slate-600">{course.description}</p>

        <div className="mt-6 space-y-2.5 border-t border-slate-200 pt-5 text-xs font-semibold text-navy/75">
...
export function EducationCoursesPage({ title = "Навчання" }: { title?: string }) {
  const [currentPage, setCurrentPage] = React.useState(1);
  const totalPages = Math.ceil(COURSES.length / COURSES_PER_PAGE);
  const courseGridRef = React.useRef<HTMLDivElement | null>(null);
      ...
      <main>
        <section className="relative overflow-hidden bg-navy-deep">
          ...
          <div className="relative mx-auto max-w-[1600px] px-4 py-14 sm:px-6 sm:py-20 lg:px-10 lg:py-28">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-background/85 sm:mt-8 sm:text-lg">
              Усі курси ОСНОВА для лікарів, фізичних терапевтів, тренерів і медичних команд:
              практичні модулі, клінічні розбори та освітні події на базі центру.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              >
                ПЕРЕГЛЯНУТИ КУРСИ <ArrowRight className="size-4" />
              </a>
              <AppLink
                to="/kontakty"
        ...
        <PageContainer className="py-5">
          <Breadcrumbs
            ...
            items={[
              { title: "Головна", route: "/" },
              { title, route: title === "Курси" ? "/kursy" : "/navchannia" },
            ]}
          />
        </PageContainer>

        <section className="border-y border-slate-200/70 bg-slate-50/80 py-8">
          <PageContainer>
            <div className="grid gap-4 md:grid-cols-4">
              {[
                { icon: Stethoscope, label: "Формат", value: "Практика та кейси" },
                { icon: CalendarDays, label: "Розклад", value: "2026–2027" },
                { icon: MapPin, label: "Локація", value: "Буковель / гібридно" },
                { icon: GraduationCap, label: "Каталог", value: `${COURSES.length} курсів` },
              ].map((item) => (
                <div
                  key={item.label}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm font-extrabold text-navy">{item.value}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section id="courses" className="bg-background py-16 md:py-24">
          <PageContainer>
            <div ref={courseGridRef} className="scroll-mt-24">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.22em] text-primary">
                    УСІ КУРСИ
                  </p>
                  <h2 className="mt-3 text-3xl font-extrabold leading-tight text-navy md:text-5xl">
                    Каталог навчання
                  </h2>
                </div>
                <p className="max-w-xl text-sm leading-relaxed text-slate-600 md:text-base">
                  Показано {visibleCourses.length} курсів на сторінці {currentPage} з {totalPages}.
              ...
              <div className="mt-10 grid gap-7 sm:grid-cols-2 xl:grid-cols-4">
                {visibleCourses.map((course) => (
                  <CourseCard key={`${course.title}-${course.date}`} course={course} />
                ))}
              </div>
                ...
                {Array.from({ length: totalPages }).map((_, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex size-10 items-center justify-center rounded-full text-sm font-extrabold transition-all ${
                        isActive
                          ? "bg-primary text-white shadow-md"
                          : "border border-slate-200 bg-white text-navy shadow-sm hover:border-primary hover:text-primary"
                      }`}
                    >
                      {page}
                    </button>
        ...
        <section className="bg-soft-blue py-20 md:py-24">
          <PageContainer className="text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-extrabold leading-tight text-navy md:text-5xl">
              Потрібна програма для себе або команди?
            </h2>
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-navy/75 md:text-lg">
              Напишіть нам, і адміністратор допоможе уточнити дату, формат, кількість місць та
              деталі участі.
            </p>
            <AppLink
              to="/kontakty"
