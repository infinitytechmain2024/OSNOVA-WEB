...
const TIMING_COLUMNS = [
  ...
  {
    title: "Протипоказання до реабілітації",
    tone: "warning",
    items: [
      "Нестабільна стенокардія або часті напади болю в грудях у спокої.",
      "Неконтрольовані порушення ритму серця, які можуть бути небезпечними під час навантажень.",
      "Гостра серцева недостатність у стадії декомпенсації.",
      "Важкі супутні захворювання в період загострення.",
      "Стійко підвищений артеріальний тиск, який не піддається корекції ліками.",
      "Будь-які стани, при яких фізичні навантаження можуть завдати шкоди здоров’ю (рішення завжди приймає лікар).",
    ],
  },
];
...
const PROCESS_STEPS = [
  ...
  },
  {
    ...
    text: "Фахівці допомагають впоратися з тривогою і страхами, пов’язаними з хворобою. Регулярно оцінюють прогрес і за потреби коригують програму, щоб вона залишалася ефективною та безпечною.",
  },
];
...
const CARDIO_CONDITIONS = [
  {
    ...
    text: "Після інфаркту програма допомагає серцю відновити роботу і поступово повернути людині звичну активність. Пацієнт навчається безпечно збільшувати навантаження, контролювати фактори ризику та справлятися зі страхом повторної події. Особливу увагу приділяють правильному диханню, ходьбі та зміцненню загальної витривалості.",
  },
  {
    title: "Реабілітація після стентування коронарних артерій",
    text: "Після встановлення стентів важливо не лише відновити фізичну форму, а й закріпити звички, які підтримують прохідність судин. Програма включає дозовані тренування, контроль тиску та ліпідів, навчання харчуванню і регулярному прийому ліків. Це допомагає зменшити ризик повторного звуження артерій.",
  },
  {
    title: "Реабілітація після аортокоронарного шунтування",
    text: "Після шунтування відновлення проходить у кілька етапів. Спочатку працюють над дихальною гімнастикою та обережним розширенням рухів, щоб не нашкодити післяопераційній рані. Далі додають вправи на зміцнення м’язів і судин. Програма допомагає безпечно повернутися до побутової та професійної активності з урахуванням особливостей операції.",
  }
];
