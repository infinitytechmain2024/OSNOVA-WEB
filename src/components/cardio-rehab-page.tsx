...
export function CardioRehabPage({ node }: { node: SiteNode }) {
  ...
  const scrollToContact = () => {
    const el = document.getElementById("online-application") || document.getElementById("cta-section") || document.getElementById("contacts-footer");
    if (el) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* 2 — Що таке кардіологічна реабілітація? */}
        ...
        {/* 3 — Коли варто розпочати кардіологічну реабілітацію? */}
        <section className="mx-auto max-w-[1400px] px-4 sm:px-6 py-10 sm:py-16 lg:px-10">
          <div className="rounded-2xl sm:rounded-3xl bg-card p-5 sm:p-8 md:p-12 border border-border/50 shadow-sm">
            ...
            <p className="mt-6 sm:mt-8 text-sm sm:text-lg leading-relaxed text-navy/85">
              {data.signsIntro}
            </p>
            ...
            <ul className="mt-4 sm:mt-6 space-y-3">
              {data.signsItems.map((s) => (
                <li key={s} className="flex gap-3 text-sm sm:text-base text-navy/90">
        ...
        {/* 5 — Результати кардіологічної реабілітації */}
        <section className="mx-auto max-w-[1600px] px-4 sm:px-6 pb-10 sm:pb-16 lg:px-10">
              ...
              <ul className="mt-6 sm:mt-10 space-y-1">
                {data.resultsItems.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-sm sm:text-base text-navy/90">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section className="mx-auto max-w-[1600px] px-4 sm:px-6 pb-10 sm:pb-16 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            {/* Праворуч: Коли планову програму варто відкласти */}
            <div className="lg:col-span-2 rounded-2xl sm:rounded-3xl border border-border bg-card p-5 sm:p-8 md:p-12 shadow-sm h-full">
              ...
              <div className="mt-4 sm:mt-6 grid gap-x-16 gap-y-4 sm:gap-y-5 md:grid-cols-2">
                {[...data.postponeLeft, ...data.postponeRight].map((item, idx) => (
                  ...
                  >
                    <span className="mt-1.5 mr-3 size-1.5 shrink-0 rounded-full bg-navy/40" />
                    {item}
                  </p>
                ))}
              </div>
        ...
        {/* 7 — Як часто проходять кардіологічну реабілітацію? */}
        <section className="mx-auto max-w-[1600px] px-4 sm:px-6 pb-10 sm:pb-16 lg:px-10">
          <div className="rounded-2xl sm:rounded-3xl bg-card p-5 sm:p-8 md:p-12">
            <div className="section-shell grid gap-8 lg:gap-12 lg:grid-cols-2">
              <div className="flex flex-col">
          ...
          <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-10">
              ...
              {visibleMethods.map((m) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6 sm:p-8">
                    ...
                    {m.expandedText && (
                      <ExpandableCardText expandedText={m.expandedText} />
                    )}
            ...
            <div className="mt-8 sm:mt-12 flex flex-col md:flex-row items-center gap-4 sm:gap-6 rounded-2xl bg-[#e2edf9] p-4 sm:p-6 md:p-8">
              ...
              <button
                type="button"
                onClick={scrollToContact}
                className="w-full md:w-auto inline-flex items-center justify-center gap-3 rounded-lg bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 shrink-0"
              >
...
function ExpandableCardText({
  ...
  return (
    <>
      <div
        className={cn(
          "mt-4 text-sm sm:text-base text-navy/70 overflow-hidden transition-all duration-300 whitespace-pre-line",
