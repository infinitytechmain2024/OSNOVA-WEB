  ...
  faq: [
    {
      ...
      answer:
        "Терміни залежать від перебігу інфаркту, проведеного лікування та загального стану людини. Рішення про початок та допустимий рівень фізичної активності приймається після оцінки стану пацієнта.",
    },
    {
      question: "Чи можна проходити реабілітацію після стентування?",
      answer:
        "Так, після стабілізації стану реабілітація може бути частиною відновлення після інфаркту та стентування. Конкретні навантаження та терміни початку визначаються індивідуально.",
    },
    {
      question: "Чи безпечні фізичні навантаження після інфаркту?",
      answer:
        "Фізична активність після інфаркту має бути дозованою та відповідати стану людини. Перед початком програми визначається допустимий рівень навантаження, а його інтенсивність поступово коригується відповідно до реакції організму.",
    },
    {
      question: "Скільки триває реабілітація після інфаркту?",
      answer:
        "Тривалість залежить від стану пацієнта, фізичної витривалості, супутніх захворювань, поставлених цілей та формату програми. Для одних пацієнтів достатньо короткого етапу, іншим може бути рекомендована більш тривала програма.",
    },
    {
      question: "Чи потрібно проходити обстеження перед початком реабілітації?",
      answer:
        "Перед початком програми необхідно оцінити стан серцево-судинної системи та можливість виконання фізичних навантажень. Перелік додаткових обстежень визначається лікарем за необхідності.",
    },
    {
      question: "Чи потрібне направлення лікаря для запису?",
      answer:
        "Для первинного звернення ви можете зв'язатися з адміністратором без направлення. Якщо у вас є направлення, виписка або інші медичні документи, бажано надати їх перед консультацією.",
    },
    {
      question: "Які документи потрібно взяти на консультацію?",
      answer:
        "Бажано мати виписку зі стаціонару, результати проведених обстежень, документи щодо стентування або операції, висновки лікарів та перелік препаратів, які ви приймаєте. Якщо частини документів немає, це не є перешкодою для первинного звернення.",
    },
    {
      question: "Чи можна проходити реабілітацію амбулаторно?",
      answer:
        "Так, за відповідного стану реабілітація може проходити амбулаторно. Оптимальний формат визначається з урахуванням необхідного рівня медичного контролю та можливості регулярно відвідувати центр.",
    },
    {
      question: "Чи можна після програми продовжувати заняття самостійно?",
      answer:
        "Після оцінки результатів фахівці можуть надати рекомендації щодо подальшої фізичної активності. Самостійні заняття повинні відповідати визначеному безпечному рівню навантаження.",
    },
    {
      question: "Як дізнатися вартість реабілітації після інфаркту?",
      answer:
        "Вартість залежить від тривалості програми, кількості занять, консультацій, необхідної діагностики та формату проходження реабілітації. Попередню інформацію можна переглянути на сайті, отримати у адміністратора або під час онлайн-консультації.",
    },
  ],
  children: [
...
const rehab: SiteNode = {
  ...
  children: [
    ...
    simpleRehabDirection(
      "profilaktychna",
      "Профілактична (превентивна) реабілітація",
