...
const cardioRehab: SiteNode = {
  ...
  pageContent: {
    ...
    introBody:
      "Кардіологічна реабілітація — це не просто фізичні вправи. Це комплексне відновлення після інфаркту, операцій на серці або при серцево-судинних захворюваннях.",
    introExpandedBody:
