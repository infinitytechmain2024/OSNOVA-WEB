...
const cardioRehab: SiteNode = {
  ...
  pageContent: {
    ...
    introBody:
      "Кардіологічна реабілітація допомагає безпечно повернутися до активного життя після інфаркту, операцій на серці та при серцево-судинних захворюваннях. Відновлення проходить під медичним контролем за індивідуальною програмою.",
    introExpandedBody:
      "Вона допомагає серцю безпечніше адаптуватися до навантажень, повернути фізичну витривалість, покращити самопочуття та знизити ризик повторних серцево-судинних ускладнень.\n\nПісля хвороби багато людей бояться навантажень, обмежують свою активність і не знають, що їм дозволено робити. Реабілітація допомагає поступово повернути впевненість у власному організмі та навчитися безпечно жити після перенесених проблем із серцем.\n\nЩо допомагає покращити кардіологічна реабілітація?\n• допомагає подолати страх перед фізичними навантаженнями після хвороби;\n• повертає впевненість у можливостях власного організму;\n• покращує витривалість і переносимість повсякдневних навантажень;\n• допомагає зменшити задишку та швидку втомлюваність;\n• навчає безпечно рухатися та контролювати свій стан;\n• допомагає поступово повернутися до звичного способу життя;\n• сприяє контролю факторів ризику та профілактиці повторних серцево-судинних подій.\n\nУ межах реабілітації пацієнт отримує індивідуальні рекомендації, навчається правильно розподіляти навантаження, контролювати свій стан та поступово відновлювати активність.\n\nКардіологічна реабілітація — це шлях не просто до кращої фізичної форми, а до більш безпечного та впевненого житті після захворювання серця.",
    recommendedTitle: "ЩО ВХОДИТЬ У ПРОГРАМУ РЕАБІЛІТАЦІЇ?",
    recommendedSubtitle:
      "Перед початком програми спеціалісти оцінюють стан серцево-судинної системи, результати обстежень, перенесене лікування, супутні захворювання, рівень фізичної активності та можливі обмеження.",
    recommendedItems: [],
    recommendedExpandedText:
      "Програма реабілітації може включати:\n\nВідновлення фізичної активності\n• індивідуально підібрані тренування з урахуванням стану серця;\n• поступове збільшення витривалості та переносимості навантажень;\n• аеробні та силові вправи під контролем спеціалістів;\n• навчання безпечному виконанню фізичної активності.\n\nМедичний контроль і безпека\n• контроль артеріального тиску, пульсу та самопочуття;\n• оцінку реакції організму на фізичне навантаження;\n• визначення безпечного рівня активності;\n• корекцію рекомендацій залежно від результатів відновлення.\n\nКонтроль факторів серцево-судинного ризику\n• рекомендації щодо харчування та способу життя;\n• контроль артеріального тиску, ваги, рівня глюкози та інших показників за потреби;\n• формування навичок самоконтролю та профілактики повторних серцево-судинних подій.\n\nПовернення до повноцінного життя\n• подолання страху перед фізичними навантаженнями;\n• відновлення впевненості у власних можливостях;\n• рекомендації щодо повернення до побутових навантажень, роботи та регулярної активності.\n\nПсихологічна підтримка — за потреби, оскільки після серцевих подій у пацієнтів можуть виникати тривога, страх повторного погіршення стану або невпевненість у власних можливостях.\n\nЗа результатами проходження реабілітації інформація про динаміку відновлення може передаватися лікуючому лікареві для подальшого спостереження за станом пацієнта та, за необхідністю, корекції лікування або рекомендацій.\n\nКожна програма формується індивідуально відповідно до стану пацієнта. Реабілітація доповнює лікування у кардіолога та допомагає зробити процес відновлення більш безпечним і ефективним.",
    postponeTitle: "Протипоказання до реабілітації",
    postponeIntro:
