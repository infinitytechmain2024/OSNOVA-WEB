...
const cardioRehab: SiteNode = {
  ...
  children: [
    program(
      ...
      "Одноденний курс оцінки та профілактичної реабілітації.",
      "1 день",
      "3 000 грн",
      cpetImg,
    ),
    program(
      ...
      "bazova",
      "Базова реабілітація",
      "7-денний базовий курс кардіологічної реабілітації під наглядом мультидисциплінарної команди.",
      "7 днів",
      "21 000 грн",
      rehabImg,
    ),
    program(
      ...
      CARDIO_REHAB_ROUTE,
      "intensyvna",
      "Інтенсивна реабілітація",
      "14-денна інтенсивна програма відновлення серцево-судинної системи та витривалості.",
      "14 днів",
      "42 000 грн",
      rehabImg,
    ),
    program(
      ...
      "povna",
      "Повна реабілітація",
      "21-денний повний комплексний курс відновлювальної кардіологічної реабілітації.",
      "21 день",
      "63 000 грн",
      rehabImg,
    ),
