...
const cardioRehab: SiteNode = {
  ...
  pageContent: {
    ...
    introBody:
      "Реабілітація в кардіології — це комплексна програма відновлення після серцево-судинних захворювань, операцій і втручань.\n\nВона поєднує оцінку стану, медичне спостереження, контрольовані фізичні навантаження та рекомендації для подальшої активності.",
    recommendedTitle: "Коли рекомендована реабілітація в кардіології?",
    recommendedSubtitle:
      "Програму можуть рекомендувати після серцево-судинних подій, операцій і втручань, а також при стабільних захворюваннях серця, які обмежують фізичну активність.",
    recommendedItems: [
      "Після інфаркту міокарда",
      "Після стентування або операції на серці",
      "При зниженні витривалості",
      "При стабільному серцево-судинному захворюванні",
      "За рекомендацією лікаря",
    ],
    postponeTitle: "Коли програму потрібно відкласти?",
    postponeIntro:
      "Планову реабілітацію починають у стабільному стані. Якщо самопочуття погіршилося або з'явилися нові симптоми, заняття потрібно відкласти та повідомити лікаря.\n\nПрограму не слід починати або продовжувати без додаткової медичної оцінки:",
    postponeLeft: [
      "При новому або посиленому болю чи тиску у грудях",
      "При вираженій задишці у спокої",
      "При втраті свідомості або переднепритомному стані",
      "При новому чи неконтрольованому порушенні серцевого ритму",
      "При різкому посиленні набряків, задишки або слабкості",
    ],
    postponeRight: [
      "При значно підвищеному або неконтрольованому артеріальному тиску",
      "При гострому інфекційному захворюванні або підвищеній температурі",
      "При загостренні тяжкого супутнього захворювання",
      "Після операції або втручання, якщо лікар ще не дозволив фізичне навантаження",
    ],
    ...
    tasksTitle: "Завдання реабілітації в кардіології",
    tasks: [
      {
        title: "Поступове відновлення активності",
        text: "Послідовне збільшення обсягу руху та фізичного навантаження відповідно до стану пацієнта.",
      },
      {
        title: "Визначення допустимого навантаження",
        text: "Оцінка реакції організму та формування зрозумілих меж фізичної активності.",
      },
      {
        title: "Контроль стану під час занять",
        text: "Спостереження за самопочуттям, пульсом, артеріальним тиском і переносимістю вправ.",
      },
      {
        title: "Рекомендації після програми",
        text: "План подальшої активності, самоконтролю та продовження відновлення після завершення програми.",
      },
    ],
    programsTitle: "Програми та вартість",
    programsIntro:
      "Обсяг програми залежить від стану пацієнта, поставлених завдань і необхідної тривалості. Перед початком уточнюється, які консультації, заняття, процедури та обстеження потрібні.",
    programs: [
      {
        name: "Профілактична програма",
        text: "Короткий формат для оцінки функціонального стану, визначення допустимого рівня активності та отримання рекомендацій.",
      },
      {
        name: "Базова програма",
        text: "Основний курс із медичним супроводом, фізичною реабілітацією та контролем переносимості навантаження.",
      },
      {
        name: "Інтенсивна програма",
        text: "Розширений курс із більшою частотою занять і додатковими складовими відповідно до стану та завдань пацієнта.",
      },
      {
        name: "Повна програма",
        text: "Найбільший передбачений обсяг реабілітаційних заходів, медичного спостереження та контрольних етапів.",
      },
    ],
    programsFooterText:
    ...
    programsFooterButton: "ДІЗНАТИСЯ ПРО УМОВИ ПРОГРАМИ",
    ctaMiddleTitle: "Не знаєте, з якої програми почати?",
    ctaMiddleText:
      "Не потрібно самостійно обирати пакет і перелік процедур. Повідомте про перенесене захворювання, операцію або втручання — адміністратор пояснить, які документи потрібно підготувати та з чого починається програма.",
    ctaMiddleButton: "ОТРИМАТИ КОНСУЛЬТАЦІЮ",
    stagesTitle: "Як проходить програма в ОСНОВІ",
    stages: [
      {
        title: "Звернення",
    ...
    expandableSections: [
      {
        title: "Що таке реабілітація в кардіології?",
        visibleText:
          "Реабілітація в кардіології — це комплексна програма відновлення після серцево-судинних захворювань, операцій і втручань.\n\nВона поєднує оцінку стану, медичне спостереження, контрольовані фізичні навантаження та рекомендації для подальшої активності.",
        expandedText:
          "Перед початком програми враховуються основний діагноз, перенесене лікування, результати обстежень, супутні захворювання, самопочуття та лікарські засоби, які приймає пацієнт.\n\nЗа потреби проводиться додаткова діагностика, щоб оцінити роботу серцево-судинної системи, переносимість навантаження та можливі обмеження.\n\nПрограма може включати:\n• консультації та медичне спостереження;\n• контроль артеріального тиску, пульсу і самопочуття;\n• заняття з фізичної реабілітації;\n• контрольовані аеробні вправи;\n• силові вправи відповідної інтенсивності;\n• дихальні вправи;\n• навчання самоконтролю під час фізичної активності;\n• рекомендації щодо режиму дня та повсякденних навантажень;\n• рекомендації щодо харчування і факторів серцево-судинного ризику;\n• психологічну підтримку — за потреби;\n• додаткові відновлювальні методи — за показаннями.\n\nФізіотерапія, гідрокінезіотерапія, лікувальний масаж та інші процедури не є обов'язковими для кожного пацієнта. Їх включають до програми лише тоді, коли вони відповідають стану людини, завданням відновлення та не мають протипоказань.\n\nПрограма не замінює лікування у кардіолога та не передбачає самостійного скасування або зміни призначених препаратів.",
      },
      {
        title: "Коли рекомендована реабілітація в кардіології?",
        visibleText:
          "Програму можуть рекомендувати після серцево-судинних подій, операцій і втручань, а також при стабільних захворюваннях серця, які обмежують фізичну активність.\n\nОсновні випадки:\n• після інфаркту міокарда;\n• після стентування або операції на серці;\n• при зниженні витривалості;\n• при стабільному серцево-судинному захворюванні;\n• за рекомендацією лікаря.",
        expandedText:
          "Реабілітація в кардіології може бути частиною відновлення:\n• після інфаркту міокарда;\n• після стентування коронарних артерій;\n• після аортокоронарного шунтування;\n• після протезування або реконструкції клапанів серця;\n• після встановлення кардіостимулятора;\n• при ішемічній хворобі серця;\n• при стабільній стенокардії;\n• при хронічній серцевій недостатності у стабільному стані;\n• при окремих стабільних порушеннях серцевого ритму;\n• при контрольованій гіпертонічній хворобі, якщо необхідно безпечно відновити фізичну активність;\n• після тривалого обмеження рухової активності через серцево-судинне захворювання;\n• при необхідності повернення до роботи, побутових навантажень або регулярних тренувань.\n\nНаявність діагнозу не означає, що кожному пацієнту підходить однаковий формат занять. Перед початком потрібно оцінити стабільність стану, симптоми, результати лікування та можливі протипоказання.\n\nПісля нещодавнього інфаркту, операції або іншого втручання терміни початку програми та допустимий рівень навантаження визначаються після медичної оцінки.",
      },
      {
        title: "Як формується програма та скільки вона триває?",
        visibleText:
          "Зміст, інтенсивність і тривалість програми визначаються з урахуванням діагнозу, перенесеного лікування, результатів обстежень і переносимості фізичного навантаження.\n\nПід час реабілітації план може змінюватися відповідно до самопочуття та реакції організму.",
        expandedText:
    ...
    pricePrimary: [
      { name: "Профілактична програма", time: "потрібне підтвердження", price: "потрібне підтвердження" },
      { name: "Базова програма", time: "потрібне підтвердження", price: "потрібне підтвердження" },
      { name: "Інтенсивна програма", time: "потрібне підтвердження", price: "потрібне підтвердження" },
