...
const cardioRehab: SiteNode = {
  ...
  indicationsIntro:
    "Програма кардіологічної реабілітації призначена для пацієнтів, які потребують безпечного та контрольованого відновлення фізичної активності після перенесених серцево-судинних подій чи операцій.",
  indications: [
    "Після стабілізації стану після перенесеного серцево-судинного захворювання, операції або хірургічного втручання",
    "При зниженні загальної витривалості та переносимості щоденних фізичних навантажень",
    "За рекомендацією лікуючого кардіолога чи кардіохірурга",
  ],
  results: [
