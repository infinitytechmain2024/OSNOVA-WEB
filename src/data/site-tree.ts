...
const cardioRehab: SiteNode = {
  ...
  pageContent: {
    ...
    pricePrimary: [
      { name: "Профілактична реабілітація", time: "1 день", price: "3 000 грн" },
      { name: "Базова реабілітація", time: "7 днів", price: "21 000 грн" },
      { name: "Інтенсивна реабілітація", time: "14 днів", price: "42 000 грн" },
      { name: "Повна реабілітація", time: "21 день", price: "63 000 грн" },
    ]
  },
  children: [
    {
