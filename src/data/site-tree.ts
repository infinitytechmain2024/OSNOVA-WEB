...
const cardioRehab: SiteNode = {
  ...
  published: true,
  featured: true,
  indicationsTitle: "Коли варто розпочати кардіологічну реабілітацію?",
  indicationsIntro:
    "Програма кардіологічної реабілітації може розглядатися після стабілізації стану після серцево-судинного захворювання, операції або втручання, при зниженні витривалості чи за рекомендацією лікаря.",
  indications: [
    "Після стабілізації стану після серцево-судинного захворювання, операції або втручання",
    "При зниженні загальної витривалості та переносимості щоденних навантажень",
    "За рекомендацією лікуючого лікаря",
  ],
  results: [
    "Покращення переносимості фізичних навантажень та загальної витривалості",
    "Поступове відновлення впевненості у повсякденній руховій активності",
    "Формування навичок самоконтролю артеріального тиску, пульсу та самопочуття",
    "Отримання персональних рекомендацій щодо безпечного способу життя та фізичних вправ",
  ],
  ...rehabDefaults,
  pageContent: {
