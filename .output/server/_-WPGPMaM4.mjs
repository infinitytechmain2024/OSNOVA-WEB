...
import { t as Route$1 } from "./_-D29xQd0O.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-WPGPMaM4.js
															...
															children: [
																...
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
																	...
																	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																		...
																		children: item.priceLabel || "За запитом"
																	})
																}),
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
																	...
																	children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLink, {
																		...
																		children: ["Перейти ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3.5" })]
																	})
																})
															]
														}, item.id))
													...
													children: [
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: ["Перейти ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3" })]
															})]
														})
													]
												}, item.id))
...
var TIMING_COLUMNS = [
	...
	},
	{
		...
		iconBg: "bg-amber-50",
		tone: "warning",
		items: ["Гострі стани, декомпенсація захворювань, деякі протипоказання.", "Рішення приймає лікар після оцінки ваших документів."]
	}
];
var PROCESS_STEPS$1 = [
	{
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WhenToPassCardioRehabBlock, {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										...
										children: "Які напрямки реабілітації та лікування можна пройти в «Основа»?"
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "Основні напрями, з якими може працювати команда після попереднього ознайомлення з документами та оцінки стану."
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					id: "process",
					className: "scroll-mt-24 bg-navy-deep py-14 text-background sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "max-w-3xl",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-5 text-sm leading-relaxed text-background/78 sm:text-base",
									children: "Процес не рухається “за календарем”. Навантаження змінюють після оцінки самопочуття, реакції організму та медичних рекомендацій."
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "relative mt-9 grid gap-4 lg:grid-cols-4",
							children: PROCESS_STEPS$1.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "relative rounded-2xl border border-background/12 bg-background/8 p-5 lg:min-h-[250px]",
								children: [
									index < PROCESS_STEPS$1.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute left-[calc(100%-10px)] top-10 hidden h-px w-8 bg-background/24 lg:block" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "flex size-12 items-center justify-center rounded-full bg-brand-green text-lg font-extrabold text-brand-green-foreground",
										children: index + 1
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-sm leading-relaxed text-background/76",
										children: step.text
									})
								]
							}, step.title))
				...
				faqItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageSection, {
					id: "faq",
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FAQAccordion, { items: faqItems })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
...
function TimingSection() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bg-soft-blue p-5 sm:p-8 lg:p-10",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading$1, {
					...
					className: "shrink-0 items-center gap-3 md:flex hidden",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			...
			children: TIMING_COLUMNS.map((column) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-start gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("flex size-10 shrink-0 items-center justify-center rounded-full", column.iconBg),
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: cn("size-5", column.iconColor) })
							...
							children: column.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								className: "flex gap-3 text-sm leading-relaxed text-navy/76",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mt-2 size-1.5 shrink-0 rounded-full bg-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item })]
							}, item))
						})] })]
					})
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
					...
					children: program.priceLabel || "Уточнюється"
				})] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function MilitaryInfoCard() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		className: "flex min-h-[320px] flex-col justify-center rounded-2xl border border-brand-green/25 bg-brand-green/10 p-6 shadow-sm",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
			className: "text-lg font-extrabold text-navy",
			children: "Для військових"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-3 text-sm leading-relaxed text-navy/72",
			children: "Діють спеціальні умови та знижки на програми відновлення."
		})]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "bg-slate-50/80 py-16 border-y border-border/60",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageContainer, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mx-auto max-w-3xl text-center",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "text-2xl font-extrabold sm:text-3xl lg:text-4xl text-navy tracking-tight",
									children: "Оберіть зручний спосіб зв'язку"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mx-auto mt-5 h-1 w-16 rounded-full bg-primary" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											className: "text-base font-bold text-navy",
											children: "Стартапи в основі соціальних мереж"
										}) })]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "relative z-10 text-center max-w-md w-full p-6 rounded-2xl bg-white/95 backdrop-blur-md shadow-2xl border border-white/50",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mx-auto flex size-14 items-center justify-center rounded-2xl bg-primary text-white shadow-lg shadow-primary/30 mb-3",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "size-7" })
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "inline-block rounded-full bg-emerald-100 px-3 py-0.5 text-[11px] font-bold text-emerald-800 uppercase tracking-wider mb-1",
												children: "📍 ДЕ МИ ЗНАХОДИМОСЬ"
											}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageContainer, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FAQAccordion, { items: [
							{
...
function AboutOsnovaPage({ node }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "overflow-hidden bg-[linear-gradient(135deg,var(--color-soft-blue),white_62%)] py-12 sm:py-16 lg:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14 xl:gap-20",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-xs font-bold uppercase tracking-[0.24em] text-primary sm:text-sm",
								children: "ОСНОВА РЕАБІЛІТАЦІЯ"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								className: "mt-5 max-w-3xl text-4xl font-extrabold leading-[1.08] text-navy sm:text-5xl lg:text-[3.25rem] xl:text-[3.6rem]",
								children: "ОСНОВА Реабілітація — сучасний медичний центр відновлення в Буковелі"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-6 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg lg:text-xl",
								children: "ОСНОВА Реабілітація — це сучасний науково-медичний центр у серці Карпат (ТРК Буковель, с. Поляниця, Івано-Франківська область). Центр спеціалізується на комплексному відновленні здоров’я та працює за чотирма ключовими напрямками: реабілітація, оздоровлення, профілактика та діагностика."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: ["Надіслати документи", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4 transition-transform group-hover:translate-x-1" })]
								})]
							})
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -inset-5 -z-0 rounded-[38px] bg-primary/8 blur-2xl" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "relative overflow-hidden rounded-[28px] border border-white/70 bg-white shadow-2xl shadow-slate-900/15",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
