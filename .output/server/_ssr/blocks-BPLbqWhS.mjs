...
import { A as MessageSquare, At as ArrowRight, B as Instagram, F as Mail, H as House, I as LoaderCircle, M as Menu, O as Music2, Ot as ArrowUp, P as MapPin, S as PhoneCall, _ as Send, dt as Circle, gt as ChevronRight, m as ShieldCheck, n as Youtube, o as User, ot as Clock, p as Sparkles, pt as CircleCheck, r as X, tt as Facebook, vt as ChevronDown, x as Phone, yt as Check, z as Languages } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/blocks-BPLbqWhS.js
...
var cardioRehab = {
	...
	children: [{
		...
		type: "service",
		title: "Реабілітація після інфаркту міокарда",
		shortDescription: "Індивідуальна програма кардіологічного відновлення для безпечного повернення до активності після інфаркту міокарда.",
		...
		seoDescription: "Програма кардіологічної реабілітації після інфаркту міокарда в ОСНОВА: оцінка стану, контрольовані навантаження, формати участі та актуальна вартість програм.",
		faq: [
			{
				question: "Коли можна розпочинати реабілітацію після інфаркту?",
				answer: "Початок програми визначають індивідуально після стабілізації стану, аналізу виписки, результатів обстежень і рекомендацій кардіолога."
			},
			{
				question: "Які документи потрібні перед першою консультацією?",
				answer: "Бажано підготувати виписку зі стаціонару, результати обстежень, висновок кардіолога та перелік препаратів, які ви приймаєте."
			},
			{
				question: "Чи можна проходити програму амбулаторно?",
				answer: "Так, якщо стан дозволяє. Формат участі визначається після первинної оцінки та залежить від потрібного рівня контролю."
			},
			{
				question: "Скільки триває програма?",
				answer: "Тривалість залежить від вихідного стану, реакції на навантаження та цілей відновлення. План коригується в динаміці."
			},
			{
				question: "Чи потрібен дозвіл кардіолога?",
				answer: "Якщо у вас є рекомендації кардіолога, їх обов’язково враховують. Остаточне рішення про старт програми приймається після оцінки документів і стану пацієнта."
			},
			{
				question: "Як контролюється фізичне навантаження?",
				answer: "Фахівці орієнтуються на самопочуття, пульс, артеріальний тиск, переносимість вправ і темп відновлення після навантаження."
			}
		]
