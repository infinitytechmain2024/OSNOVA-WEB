...
import { S as service_sports_default, b as service_checkup_default, d as SiteFooter, f as SiteHeader, g as ergometer_default, h as ecg_review_default, m as cpet_test_default, n as Breadcrumbs, p as cn, t as AppLink, w as useConsultationModal, x as service_rehab_default } from "./blocks-CcgCGD_9.mjs";
...
import { t as NEWS_ARTICLES } from "./news-oORjDLlC.mjs";
import { t as useEmblaCarousel } from "../_libs/embla-carousel-react+[...].mjs";
import { t as Autoplay } from "../_libs/embla-carousel-autoplay.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-B1PoUH1u.js
...
function CooperationCard({ item, index, isActive = false, isNext = false, onClick }) {
	...
	const baseClassName = `cooperation-card group ${isActive ? "cooperation-card--active" : isNext ? "cooperation-card--adjacent cooperation-card--inactive" : "cooperation-card--inactive"}`;
	const baseStyle = { zIndex: COOPERATION_ITEMS.length - index };
	if (isNext) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		onClick,
		type: "button",
...
function Index() {
	...
	const goToCooperationStep = import_react.useCallback((direction) => {
		...
		setCooperationCurrentSlide((prev) => {
			const nextIndex = Math.min(Math.max(prev + direction, 0), COOPERATION_ITEMS.length - 1);
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									style: {
										transform: cooperationStepHeight ? `translateY(-${cooperationCurrentSlide * cooperationStepHeight}px)` : `translateY(calc(-${cooperationCurrentSlide} * (var(--card-height) - 1.15rem)))`,
