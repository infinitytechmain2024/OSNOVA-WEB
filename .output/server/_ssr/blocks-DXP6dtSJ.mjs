...
import { D as Music2, Dt as ArrowUp, F as LoaderCircle, N as MapPin, P as Mail, R as Languages, V as House, _t as ChevronDown, at as Clock, b as Phone, et as Facebook, ft as CircleCheck, g as Send, ht as ChevronRight, j as Menu, k as MessageSquare, kt as ArrowRight, m as ShieldCheck, n as Youtube, o as User, p as Sparkles, r as X, ut as Circle, vt as Check, x as PhoneCall, z as Instagram } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/blocks-DXP6dtSJ.js
...
var cardioRehab = {
	...
	faq: [
		{
			question: "Коли можна починати реабілітацію після інфаркту?",
			answer: "Терміни залежать від перебігу інфаркту, проведеного лікування та загального стану людини. Рішення про початок та допустимий рівень фізичної активності приймається після оцінки стану пацієнта."
		},
		{
			question: "Чи можна проходити реабілітацію після стентування?",
			answer: "Так, після стабілізації стану реабілітація може бути частиною відновлення після інфаркту та стентування. Конкретні навантаження та терміни початку визначаються індивідуально."
		},
		{
			question: "Чи безпечні фізичні навантаження після інфаркту?",
			answer: "Фізична активність після інфаркту має бути дозованою та відповідати стану людини. Перед початком програми визначається допустимий рівень навантаження, а його інтенсивність поступово коригується відповідно до реакції організму."
		},
		{
			question: "Скільки триває реабілітація після інфаркту?",
			answer: "Тривалість залежить від стану пацієнта, фізичної витривалості, супутніх захворювань, поставлених цілей та формату програми. Для одних пацієнтів достатньо короткого етапу, іншим може бути рекомендована більш тривала програма."
		},
		{
			question: "Чи потрібно проходити обстеження перед початком реабілітації?",
			answer: "Перед початком програми необхідно оцінити стан серцево-судинної системи та можливість виконання фізичних навантажень. Перелік додаткових обстежень визначається лікарем за необхідності."
		},
		{
			question: "Чи потрібне направлення лікаря для запису?",
			answer: "Для первинного звернення ви можете зв'язатися з адміністратором без направлення. Якщо у вас є направлення, виписка або інші медичні документи, бажано надати їх перед консультацією."
		},
		{
			question: "Які документи потрібно взяти на консультацію?",
			answer: "Бажано мати виписку зі стаціонару, результати проведених обстежень, документи щодо стентування або операції, висновки лікарів та перелік препаратів, які ви приймаєте. Якщо частини документів немає, це не є перешкодою для первинного звернення."
		},
		{
			question: "Чи можна проходити реабілітацію амбулаторно?",
			answer: "Так, за відповідного стану реабілітація може проходити амбулаторно. Оптимальний формат визначається з урахуванням необхідного рівня медичного контролю та можливості регулярно відвідувати центр."
		},
		{
			question: "Чи можна після програми продовжувати заняття самостійно?",
			answer: "Після оцінки результатів фахівці можуть надати рекомендації щодо подальшої фізичної активності. Самостійні заняття повинні відповідати визначеному безпечному рівню навантаження."
		},
		{
			question: "Як дізнатися вартість реабілітації після інфаркту?",
			answer: "Вартість залежить від тривалості програми, кількості занять, консультацій, необхідної діагностики та формату проходження реабілітації. Попередню інформацію можна переглянути на сайті, отримати у адміністратора або під час онлайн-консультації."
		}
	],
...
var POST_INFARCTION_REHAB_ROUTE = "/reabilitatsiia/pislia-infarktu-miokarda";
var postInfarctionPrograms = CARDIO_REHAB_PROGRAMS.map((program) => ({
	...program,
	detailsUrl: `${POST_INFARCTION_REHAB_ROUTE}/${program.id}`,
	price: program.price
}));
var postInfarctionRehab = {
	...
	shortDescription: "Поетапне відновлення після інфаркту міокарда з медичним контролем, дозованими навантаженнями та персональним підбором методів реабілітації.",
	fullDescription: "Програма реабілітації після інфаркту міокарда формується індивідуально з урахуванням перебігу гострого періоду, функціонального стану серця, переносимості навантаження та супутніх факторів ризику.",
	duration: "1–21 день",
	priceLabel: "3 000 грн",
	image: cpet_test_default,
	published: true,
	...
	...rehabDefaults,
	faq: cardioRehab.faq,
	children: [...postInfarctionPrograms.map((programData) => ({
		...program("rehab-post-infarction", POST_INFARCTION_REHAB_ROUTE, programData.id, programData.title, programData.description, `${programData.duration} / ${programData.format}`, programData.price, service_rehab_default),
		route: programData.detailsUrl,
		duration: programData.duration,
		priceLabel: programData.price,
		shortDescription: programData.description,
...
var orthoRehab = {
	...
	parentId: "rehab",
	type: "direction",
	title: "Реабілітація в ортопедії та травматології",
	eyebrow: "РЕАБІЛІТАЦІЯ",
	route: ORTHO_ROUTE,
...
var vertRehab = {
	...
	parentId: "rehab",
	type: "direction",
	title: "Реабілітація у вертебрології",
	eyebrow: "РЕАБІЛІТАЦІЯ",
	route: VERT_ROUTE,
...
var rehab$2 = {
	...
	children: [
		...
		simpleRehabDirection("revmatolohichna", "Реабілітація в ревматології", "Підтримка рухливості суглобів і функціональності при ревматологічних захворюваннях.", "1 700 грн / день"),
		simpleRehabDirection("psykholohichna", "Психічне (ментальне) здоров’я", "Психологічний супровід під час відновлення та адаптації до змін.", "1 200 грн / сеанс"),
		simpleRehabDirection("profilaktychna", "Профілактична (превентивна) реабілітація", "Програми для збереження здоров'я, рухливості та витривалості.", "1 400 грн / день"),
		simpleRehabDirection("sportyvna", "Спортивна медицина", "Відновлення після спортивних травм, покращення результатів та профілактика.", "1 800 грн / день")
	]
};
...
function SectionHeader({ eyebrow, eyebrowClassName, title, text }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		eyebrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: cn("text-xs font-semibold tracking-[0.2em] text-primary sm:text-sm sm:tracking-[0.28em]", eyebrowClassName),
			children: eyebrow
		}),
...
function Breadcrumbs({ items, className, align = "left" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		"aria-label": "Навігаційний ланцюжок",
		className: cn("pt-4 sm:pt-8 overflow-x-auto scrollbar-none", className),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
			className: cn("flex items-center gap-2 text-xs sm:text-sm text-navy/60 whitespace-nowrap", align === "center" && "justify-center"),
...
function FAQAccordion({ items, variant = "default" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("script", {
		...
		className: cn(variant === "home" ? "mt-12 space-y-5" : "mt-10 space-y-3"),
		children: items.map((item, i) => {
			const isOpen = open.includes(item.question);
			const panelId = `faq-panel-${i}`;
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				className: cn(variant === "home" ? "rounded-2xl border border-slate-200 bg-white px-6 py-2 shadow-sm transition-all hover:border-primary/30 hover:shadow-md md:px-8" : "rounded-xl border border-border bg-card"),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					"aria-expanded": isOpen,
					"aria-controls": panelId,
					onClick: () => toggle(item.question),
					className: cn("flex w-full items-center justify-between gap-6 text-left transition-colors", variant === "home" ? "py-4 text-base font-bold text-navy hover:text-primary md:text-lg" : "px-6 py-5 text-navy", isOpen && variant === "home" && "text-primary"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn(variant === "home" ? "" : "font-semibold"),
						children: item.question
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cn(variant === "home" ? "size-5 shrink-0 text-muted-foreground transition-transform duration-300" : "size-5 shrink-0 text-primary transition-transform duration-200", isOpen && "rotate-180") })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					id: panelId,
					hidden: !isOpen,
					className: cn("transition-all duration-200", variant === "home" ? "pb-6 text-sm leading-relaxed text-slate-600 md:text-base" : "px-6 pb-5 text-navy/85"),
...
//#endregion
export { getNodeById as C, service_sports_default as D, service_rehab_default as E, siteTree as O, getBreadcrumbs as S, service_checkup_default as T, SiteHeader as _, ConsultationForm as a, ecg_review_default as b, DialogContent as c, DialogTitle as d, FAQAccordion as f, SiteFooter as g, SectionHeader as h, CONTACTS as i, useConsultationModal as k, DialogDescription as l, PageContainer as m, Breadcrumbs as n, ConsultationModalProvider as o, IMAGES as p, CARDIO_REHAB_PROGRAMS as r, Dialog as s, AppLink as t, DialogHeader as u, cn as v, getNodeByRoute as w, ergometer_default as x, cpet_test_default as y };
