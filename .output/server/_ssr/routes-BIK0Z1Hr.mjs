...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BIK0Z1Hr.js
...
function Index() {
	...
	const goToCooperationStep = import_react.useCallback((direction) => {
		...
		const nextIndex = Math.min(Math.max(cooperationCurrentSlide + direction, 0), COOPERATION_ITEMS.length - 1);
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: COOPERATION_ITEMS.map((item, index) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CooperationCard, {
											...
											isAdjacentVisible: index === nextIndex,
											onClick: () => {
