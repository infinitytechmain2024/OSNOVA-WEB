...
import { A as Menu, E as Music2, L as Languages, M as MapPin, N as Mail, O as MessageSquare, P as LoaderCircle, R as Instagram, St as ArrowRight, Z as Facebook, at as Circle, b as Phone, ft as ChevronDown, g as Send, m as ShieldCheck, n as Youtube, o as User, p as Sparkles, pt as Check, r as X, st as CircleCheck, tt as Clock, ut as ChevronRight, x as PhoneCall, xt as ArrowUp } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/site-footer-DtdGqSzK.js
...
var cardioRehab = {
	...
	children: [
		{
			...program("rehab-cardio", CARDIO_REHAB_ROUTE, "pislia-infarktu-miokarda", "Реабілітація після інфаркту міокарда", "Безпечне відновлення роботи серця після перенесеного інфаркту.", "За програмою", "від 3 000 грн", cpet_test_default),
			methods: cardioMethods
		},
		{
			...program("rehab-cardio", CARDIO_REHAB_ROUTE, "pislia-stentuvannia", "Після стентування коронарних артерій", "Адаптація до навантажень та контроль стану після стентування.", "За програмою", "від 3 000 грн", service_rehab_default),
			methods: cardioMethods
		},
		{
			...program("rehab-cardio", CARDIO_REHAB_ROUTE, "pislia-aksh", "Після аортокоронарного шунтування", "Поетапне збільшення активності після кардіохірургічного втручання.", "За програмою", "від 3 000 грн", service_rehab_default),
			methods: cardioMethods
		},
		{
			...program("rehab-cardio", CARDIO_REHAB_ROUTE, "pislia-operatsii-na-klapanakh", "Після операцій на клапанах серця", "Відновлення витривалості та стабілізація гемодинаміки.", "За програмою", "від 3 000 грн", cpet_test_default),
			methods: cardioMethods
		},
		{
			...program("rehab-cardio", CARDIO_REHAB_ROUTE, "pislia-vstanovlennia-kardiostymuliatora", "Після встановлення кардіостимулятора", "Контроль адаптації організму до заданого ритму.", "За програмою", "від 3 000 грн", service_rehab_default),
			methods: cardioMethods
		},
		{
			...program("rehab-cardio", CARDIO_REHAB_ROUTE, "pislia-porushen-rytmu", "Після порушень серцевого ритму", "Формування безпечної зони пульсу та навантаження.", "За програмою", "від 3 000 грн", ecg_review_default),
			methods: cardioMethods
		}
	]
};
...
//#endregion
export { service_sports_default as _, IMAGES as a, cn as c, ergometer_default as d, getBreadcrumbs as f, service_rehab_default as g, service_checkup_default as h, ConsultationModalProvider as i, cpet_test_default as l, getNodeByRoute as m, CONTACTS as n, SiteFooter as o, getNodeById as p, ConsultationForm as r, SiteHeader as s, AppLink as t, ecg_review_default as u, siteTree as v, useConsultationModal as y };
