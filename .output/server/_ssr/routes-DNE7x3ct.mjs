...
import { $ as Dumbbell, Ct as ArrowLeft, D as Microscope, G as GraduationCap, J as Flame, St as ArrowRight, V as Heart, a as Users, b as Phone, c as UserCheck, dt as ChevronLeft, f as Stethoscope, ft as ChevronDown, l as Trophy, lt as ChevronUp, m as ShieldCheck, mt as Calendar, rt as ClipboardList, t as Zap, ut as ChevronRight, vt as Brain, w as Network, yt as BookOpen } from "../_libs/lucide-react.mjs";
import { t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { _ as service_sports_default, c as cn, d as ergometer_default, g as service_rehab_default, h as service_checkup_default, l as cpet_test_default, o as SiteFooter, s as SiteHeader, t as AppLink, u as ecg_review_default, y as useConsultationModal } from "./site-footer-DpAKTwkw.mjs";
...
import { t as NEWS_ARTICLES } from "./news-C188zRFJ.mjs";
import { t as useEmblaCarousel } from "../_libs/embla-carousel-react+[...].mjs";
import { t as Autoplay } from "../_libs/embla-carousel-autoplay.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DNE7x3ct.js
...
function CooperationCard({ item, index, isActive = false, isAdjacentVisible = false, onClick }) {
	...
	if (isAdjacentVisible) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		onClick,
		type: "button",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "relative overflow-hidden bg-[#f4f8fd] py-24 md:py-32",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -left-[8%] top-[18%] h-[420px] w-[420px] rounded-full bg-[#bfe3ff]/50 blur-[120px]" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -right-[5%] bottom-[8%] h-[360px] w-[360px] rounded-full bg-[#d9f0ff]/70 blur-[100px]" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "relative mx-auto max-w-[1280px] px-6 lg:px-10",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "grid items-center gap-12 xl:grid-cols-[1.02fr_1.1fr]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "max-w-[610px]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mb-5 inline-flex items-center rounded-full bg-[#dfeefb] px-4 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[#17345a] shadow-sm ring-1 ring-[#cfe7f9]",
											children: "ПРО КОМПАНІЮ"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
											className: "mb-4 text-4xl font-black leading-[0.98] tracking-[-0.04em] md:text-5xl xl:text-[4.2rem]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "block text-[#142d4a]",
												children: "ОСНОВА"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "block text-[#0d66d9]",
												children: "Реабілітація"
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mb-8 h-1.5 w-24 rounded-full bg-gradient-to-r from-[#0d66d9] via-[#5ebaf9] to-[#8be0d8]" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-5 text-[17px] leading-relaxed text-[#3d5875] md:text-[18px]",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "«ОСНОВА Реабілітація — сучасна медична компанія, що спеціалізується на лікуванні та комплексній реабілітації пацієнтів у сферах кардіології, ортопедії, травматології, ревматології, вертебрології та психології.»" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "«Ми працюємо не лише з наслідками хвороб і травм, а й виявляємо ризики ще до появи симптомів — завдяки сучасній діагностиці, точним обстеженням і персоналізованим профілактичним програмам.»" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "mt-2 text-[1.15rem] font-bold leading-relaxed text-[#112f52] md:text-[1.35rem]",
													children: "«Наше завдання — допомогти вам відновити здоров'я, рухливість і якість життя.»"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "«ОСНОВА Реабілітація також є науково-освітньою платформою, що розробляє та вдосконалює протоколи лікування, співпрацює з провідними медичними університетами світу, впроваджує інноваційні технології та розвиває виїзні формати реабілітаційної допомоги для пацієнтів поза центром.»" })
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mt-9",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLink, {
												...
												children: ["ДЕТАЛЬНІШЕ ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													"aria-hidden": "true",
													children: "→"
												})]
											})
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "overflow-hidden rounded-[28px] bg-white shadow-[0_18px_44px_-28px_rgba(15,31,56,0.45)] ring-1 ring-[#dfeaf4] sm:col-span-1",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex min-h-[270px] items-center justify-center rounded-[28px] bg-[#dfeefb] p-6 text-center shadow-[0_18px_44px_-28px_rgba(15,31,56,0.4)] ring-1 ring-[#d3e7f9] sm:min-h-[320px]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "text-[3.4rem] font-black leading-none tracking-[-0.06em] text-[#0d66d9] md:text-[4.2rem]",
												children: "10+"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "mt-3 text-base font-semibold leading-snug text-[#17345a] md:text-lg",
												children: [
													"Років досвіду",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"медичної команди"
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex min-h-[270px] items-center justify-center rounded-[28px] bg-[#edf7ff] p-6 text-center shadow-[0_18px_44px_-28px_rgba(15,31,56,0.4)] ring-1 ring-[#dfeaf4] sm:min-h-[320px]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "text-[2.5rem] font-black leading-none tracking-[-0.06em] text-[#17345a] md:text-[3.2rem]",
												children: "100%"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "mt-3 max-w-[250px] text-base font-semibold leading-snug text-[#17345a] md:text-lg",
												children: "Персоналізований підхід до кожного пацієнта"
											})] })
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "overflow-hidden rounded-[28px] bg-white shadow-[0_18px_44px_-28px_rgba(15,31,56,0.45)] ring-1 ring-[#dfeaf4]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: COOPERATION_ITEMS.map((item, index) => {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CooperationCard, {
											item,
											index,
											isActive: index === cooperationCurrentSlide,
											isAdjacentVisible: (index === prevIndex || index === nextIndex) && (index === prevIndex || index === cooperationCurrentSlide || index === nextIndex),
											onClick: () => {
												if (index === prevIndex) setCooperationCurrentSlide(prevIndex);
												else if (index === nextIndex) setCooperationCurrentSlide(nextIndex);
											}
										}, item.number);
									})
								})
