...
var SUPPORT_HIGHLIGHTS = [
	{
		...
		description: "Передбачаємо пільгові умови на програми відновлення та допомагаємо швидше узгодити старт після попереднього розгляду документів.",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						"aria-hidden": true,
						children: SUPPORT_HIGHLIGHTS.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: cn("h-1 flex-1 rounded-full transition-colors duration-300", index === activeIndex ? "bg-primary" : "bg-primary/10") }, item.id))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-5 flex items-center justify-between gap-3 text-[11px] font-bold uppercase tracking-[0.16em] text-navy/55",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: activeHighlight.eyebrow }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
