...
import { $ as FileText, A as Microscope, At as Ambulance, C as PhoneCall, F as MapPin, G as HeartPulse, I as Mail, J as HandHeart, M as MessageCircle, O as Navigation, Ot as ArrowRight, P as MapPinned, S as Phone, St as Building2, T as Package, Tt as BadgeCheck, U as House, W as Heart, Y as GraduationCap, Z as FlaskConical, _ as Share2, _t as ChevronDown, a as Users, at as CloudUpload, b as Route, bt as CalendarDays, c as UserRound, ct as ClipboardList, f as Truck, ft as CircleCheck, g as ShieldCheck, gt as ChevronLeft, h as Sparkles, ht as ChevronRight, i as Wrench, it as Compass, j as MessageSquare, jt as Activity, l as UserRoundCheck, lt as ClipboardCheck, m as Stethoscope, mt as ChevronUp, nt as ExternalLink, o as UsersRound, ot as Clock, p as TriangleAlert, q as Handshake, rt as Dumbbell, v as Send, vt as Check, w as Percent, wt as BookOpen, x as Presentation, y as Search, z as Layers } from "./_libs/lucide-react.mjs";
...
import { t as Route$1 } from "./_-DMbBwDmU.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-CTTWrZJX.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "min-w-[62px] text-[1.1rem] font-extrabold tracking-[-0.03em] text-emerald-800",
							children: [
								currentSlideLabel,
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: cn("h-1.5 rounded-full transition-all duration-300", activeIndex === index ? "w-9 bg-[linear-gradient(90deg,#1f9d68_0%,#35c88a_55%,#6ee7a8_100%)] shadow-[0_6px_16px_rgba(53,200,138,0.24)]" : "w-7 bg-emerald-100 hover:bg-emerald-200")
						}, highlight.id))]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function SupportHighlightVisual({ highlight }) {
	if (highlight.id === "senior") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "absolute left-1/2 top-8 flex h-[122px] w-[92px] -translate-x-1/2 rotate-[18deg] items-center justify-center rounded-[28px] bg-[linear-gradient(180deg,#34d67b_0%,#10a44e_100%)] shadow-[0_24px_40px_rgba(16,164,78,0.26)]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "absolute bottom-1 left-3 flex items-center gap-2 rounded-[18px] border border-emerald-100 bg-white/96 px-3 py-2 shadow-[0_16px_28px_rgba(21,128,61,0.12)]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarDays, {
					className: "size-5 text-emerald-600",
					strokeWidth: 2.1
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-[0.72rem] font-bold uppercase tracking-[0.14em] text-emerald-700",
					children: "60+"
				})]
			})
		]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "relative flex size-[118px] items-center justify-center rounded-[34px] bg-[linear-gradient(165deg,#35c88a_0%,#149b56_100%)] shadow-[0_24px_40px_rgba(16,164,78,0.24)]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
