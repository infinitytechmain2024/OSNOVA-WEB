...
import { A as MessageSquare, At as Activity, C as PhoneCall, Ct as BookOpen, D as Navigation, Dt as ArrowRight, F as Mail, H as House, J as GraduationCap, K as Handshake, N as MapPinned, P as MapPin, Q as FileText, R as Layers, S as Phone, U as Heart, W as HeartPulse, X as FlaskConical, _ as Share2, _t as Check, a as Users, at as Clock, b as Route, c as UserRound, ct as ClipboardCheck, dt as CircleCheck, f as Truck, g as ShieldCheck, gt as ChevronDown, h as Sparkles, ht as ChevronLeft, i as Wrench, it as CloudUpload, j as MessageCircle, k as Microscope, kt as Ambulance, l as UserRoundCheck, m as Stethoscope, mt as ChevronRight, nt as Dumbbell, o as UsersRound, p as TriangleAlert, pt as ChevronUp, q as HandHeart, rt as Compass, st as ClipboardList, tt as ExternalLink, v as Send, w as Package, wt as BadgeCheck, x as Presentation, xt as Building2, y as Search, yt as CalendarDays } from "./_libs/lucide-react.mjs";
...
import { t as Route$1 } from "./_-C8HqbpXC.mjs";
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				...
				faqItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FAQConsultationCTA, {
						className: "mt-16",
						cardClassName: "lg:min-h-[630px]"
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageSection, {
...
function MilitaryInfoCard() {
	...
	const buttonClassName = "inline-flex w-fit items-center gap-2 rounded-lg bg-[linear-gradient(135deg,#1f9d68_0%,#35c88a_100%)] px-5 py-3 text-sm font-bold text-white shadow-[0_16px_30px_rgba(53,200,138,0.22)] transition-all hover:-translate-y-0.5 hover:shadow-[0_20px_36px_rgba(53,200,138,0.28)]";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "inline-flex w-fit items-center rounded-full border border-emerald-200/90 bg-white/86 px-3.5 py-1 text-[0.65rem] font-extrabold uppercase tracking-[0.18em] text-emerald-700 shadow-[0_10px_24px_rgba(53,200,138,0.14)]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: SUPPORT_HIGHLIGHTS.map((highlight, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: cn("h-2.5 flex-1 rounded-full transition-all duration-300", activeIndex === index ? "bg-[linear-gradient(90deg,#1f9d68_0%,#35c88a_55%,#6ee7a8_100%)] shadow-[0_0_0_1px_rgba(31,157,104,0.18),0_8px_18px_rgba(53,200,138,0.24)]" : "bg-white/82 ring-1 ring-emerald-200/90 hover:bg-emerald-50")
						}, highlight.id))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "relative grid gap-10 xl:grid-cols-[minmax(0,1.04fr)_minmax(460px,0.88fr)] xl:items-center xl:gap-14",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "max-w-3xl xl:py-4",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "inline-flex rounded-full border border-primary/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(239,246,255,0.96)_100%)] px-5 py-2 text-xs font-extrabold uppercase tracking-[0.18em] text-primary shadow-[0_12px_28px_rgba(31,61,120,0.08)] sm:px-6 sm:text-sm",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-8 h-1.5 w-22 rounded-full bg-[linear-gradient(90deg,#2563eb_0%,#1f73ff_58%,#2ad38b_100%)] shadow-[0_10px_22px_rgba(47,99,190,0.18)] sm:w-24" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-8 max-w-[34rem] text-base leading-relaxed text-navy/72 sm:text-[1.15rem] sm:leading-[1.7]",
									children: "Ми допомагаємо повернутися до активного життя з турботою, досвідом і сучасним підходом."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mt-10 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-stretch",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										type: "button",
