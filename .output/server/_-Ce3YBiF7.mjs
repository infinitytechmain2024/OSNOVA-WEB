...
import { t as Route$1 } from "./_-Byq5-GwZ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-Ce3YBiF7.js
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mb-4 sm:mb-5 inline-flex items-center rounded-full bg-[#edf4ff] border border-[#d4e4fa] px-4.5 py-1.5 text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.15em] text-[#1b5bc9]",
										children: "ПРО КОМПАНІЮ"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
										className: "mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-[54px] xl:text-[60px] font-black tracking-tight leading-[1.06] text-[#0b192c]",
										children: ["ОСНОВА ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-[#1b5bc9]",
											children: "Реабілітація"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mb-8 h-[4px] w-20 rounded-full bg-gradient-to-r from-[#1b5bc9] via-[#1b5bc9] 50% to-[#10b981]" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "space-y-6 sm:space-y-7 text-base sm:text-[18px] lg:text-[19px] leading-[1.7] sm:leading-[1.75]",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "font-medium sm:font-semibold text-[#1e293b]",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "py-1 font-bold text-[#1b5bc9]",
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "overflow-hidden rounded-[22px] lg:rounded-[24px] bg-white shadow-[0_10px_25px_rgba(0,0,0,0.04)] border border-slate-100/90 aspect-[4/3.1] min-h-[200px] sm:min-h-[230px] lg:min-h-[250px] xl:min-h-[265px]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
