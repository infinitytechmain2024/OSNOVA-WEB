...
import { i as SectionHeader$1, n as FAQAccordion, r as PageContainer, t as Breadcrumbs } from "./_ssr/blocks-Lh4po0e0.mjs";
import { t as Route$1 } from "./_-Dq0txXDg.mjs";
import { n as ServiceDetailTemplate, r as getServicePageData, t as OtherServices } from "./_ssr/service-detail-template-VXqQFj3J.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-wuOuGf3P.js
...
function AboutOsnovaPage({ node }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "bg-white py-14 sm:py-18 lg:py-22",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "ПРО КОМПАНИЮ"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
								className: "mt-3 text-3xl font-extrabold leading-[1.2] text-navy sm:text-4xl lg:text-5xl",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Ми працюємо не лише з наслідками хвороб і травм, а й виявляємо ризики що до появи симптомів — завдяки сучасній діагностиці, точним обстеженням і персоналізованим профілактичним програмам."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									className: "mt-3 text-sm leading-relaxed text-slate-600",
									children: "ОСНОВА Реабілітація також є науково-освітною платформою, що розробляє та впроваджує інноваційні технології та розвиває різні формати реабілітаційної допомоги для пацієнтів поза центром."
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl bg-blue-50 p-6 sm:p-8 lg:p-10 text-center col-span-1 row-span-2 flex flex-col justify-center",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "text-4xl sm:text-5xl lg:text-6xl font-extrabold text-primary",
										children: "10+"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-xs sm:text-sm font-semibold text-navy",
										children: "Років досвіду медичної команди"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "rounded-2xl overflow-hidden shadow-md",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										src: functional_training_default,
										alt: "Фізіотерапія",
										loading: "lazy",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl bg-blue-50 p-6 sm:p-8 col-span-1 row-span-2 flex flex-col justify-center",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "rounded-2xl overflow-hidden shadow-md col-span-2 sm:col-span-1",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
