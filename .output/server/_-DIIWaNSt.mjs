...
//#region node_modules/.nitro/vite/services/ssr/assets/_-DIIWaNSt.js
...
function AboutOsnovaPage({ node }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "bg-white pt-8 sm:pt-12 lg:pt-14 pb-16 md:pb-24 lg:pb-28",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, {
						className: "max-w-[1480px] px-6 sm:px-8 lg:px-10 xl:px-12",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "grid items-center gap-10 lg:gap-14 xl:gap-16 lg:grid-cols-[1.08fr_1fr]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "w-full max-w-[720px] lg:max-w-none",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mb-4 sm:mb-5 inline-flex items-center rounded-full bg-[#E9EEF8] border border-[#D0DCF2] px-4.5 py-1.5 text-[11px] sm:text-[12px] font-semibold uppercase tracking-[0.15em] text-[#215FBC]",
										children: "ПРО КОМПАНІЮ"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
										className: "mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-[54px] xl:text-[60px] font-black font-extrabold tracking-tight leading-[1.06] text-[#091936]",
										children: ["ОСНОВА ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-[#215FBC]",
											children: "Реабілітація"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mb-8 h-[4px] w-20 rounded-full bg-gradient-to-r from-[#215FBC] via-[#215FBC] 50% to-[#10b981]" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "space-y-6 sm:space-y-7 text-base sm:text-[18px] lg:text-[19px] leading-[1.65]",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "font-medium text-[#091936]",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "font-normal text-[#5F6A7B]",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "py-1 font-semibold text-[#215FBC]",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											children: ["ДЕТАЛЬНІШЕ ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-4.5 w-4.5 stroke-[2.5]" })]
										})
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "w-full",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "grid grid-cols-2 gap-[28px] lg:gap-[30px]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-full min-w-0 max-w-full box-border overflow-hidden rounded-[24px] bg-white shadow-[0_10px_25px_rgba(0,0,0,0.04)] border border-slate-100/90 aspect-[4/3.15] min-h-[200px] sm:min-h-[230px] lg:min-h-[250px] xl:min-h-[270px]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "w-full min-w-0 max-w-full box-border flex flex-col justify-center rounded-[24px] bg-[#E9EEF8] p-6 sm:p-7 lg:p-8 xl:p-9 text-left shadow-[0_10px_25px_rgba(0,0,0,0.02)] aspect-[4/3.15] min-h-[200px] sm:min-h-[230px] lg:min-h-[250px] xl:min-h-[270px] transition-all duration-300 hover:shadow-[0_14px_30px_rgba(33,95,188,0.08)]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mb-2 text-4xl sm:text-5xl lg:text-[54px] xl:text-[58px] font-black font-extrabold tracking-tight text-[#215FBC] leading-none",
												children: "8+"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-xs sm:text-sm lg:text-[15px] font-medium text-[#5F6A7B] leading-snug",
												children: "Напрямків реабілітації"
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "w-full min-w-0 max-w-full box-border flex flex-col justify-center rounded-[24px] bg-[#D9EBFC] p-6 sm:p-7 lg:p-8 xl:p-9 text-left shadow-[0_10px_25px_rgba(0,0,0,0.02)] aspect-[4/3.15] min-h-[200px] sm:min-h-[230px] lg:min-h-[250px] xl:min-h-[270px] transition-all duration-300 hover:shadow-[0_14px_30px_rgba(9,25,54,0.08)]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mb-2 text-4xl sm:text-5xl lg:text-[54px] xl:text-[58px] font-black font-extrabold tracking-tight text-[#091936] leading-none",
												children: "30+"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-xs sm:text-sm lg:text-[15px] font-medium text-[#5F6A7B] leading-snug",
