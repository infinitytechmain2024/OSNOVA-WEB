...
import { t as Route$1 } from "./_-zb5DNac_.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-B99kwTG_.js
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[linear-gradient(90deg,rgba(4,15,44,0.96)_0%,rgba(4,15,44,0.92)_30%,rgba(16,33,78,0.76)_56%,rgba(22,39,82,0.58)_72%,rgba(36,51,93,0.34)_100%)]" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "relative mx-auto flex min-h-[720px] max-w-[1440px] items-center px-12 py-20 sm:px-16 lg:min-h-[820px] lg:px-20 lg:py-24 xl:px-24",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "max-w-[660px]",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "inline-flex rounded-full border border-[#b7c9e6]/60 bg-[#eef6ff] px-7 py-3 text-[0.95rem] font-extrabold uppercase tracking-[0.16em] text-[#173e8f] shadow-[0_10px_24px_rgba(10,25,60,0.16)]",
												children: "Кардіологічна реабілітація"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
												className: "mt-10 max-w-[8ch] text-[4rem] font-extrabold leading-[0.9] text-white sm:text-[4.6rem] lg:text-[5.8rem] xl:text-[6.25rem]",
												children: "Реабілітація після інфаркту міокарда"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "mt-10 max-w-[33rem] text-[1.05rem] leading-[1.8] text-white/80 sm:text-[1.15rem] lg:text-[1.2rem]",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												children: ["Замовити консультацію", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-5" })]
											})
										]
									})
								})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Breadcrumbs, {
							...
							className: "overflow-x-auto pb-7 scrollbar-none",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 max-w-4xl text-sm leading-relaxed text-navy/68 sm:text-base",
								children: "Це допомагає зрозуміти, коли відновлення може бути безпечним і яких результатів можна очікувати від програми."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mx-auto mt-3 max-w-3xl text-center text-sm leading-relaxed text-navy/66 sm:text-base",
								children: "Дізнайтеся, хто та в яких ситуаціях може пройти програму відновлення в ОСНОВА."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-8 grid gap-5 xl:grid-cols-3",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
							...
							children: [CARDIO_REHAB_PROGRAMS.map((program) => {
								...
								className: "rounded-[24px] bg-[linear-gradient(180deg,#dffbe9_0%,#b8f1cc_100%)] p-6 text-navy shadow-[0_16px_40px_rgba(53,200,138,0.16)]",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
