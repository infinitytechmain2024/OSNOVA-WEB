...
import { t as Route$1 } from "./_-BN7QrIS4.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-DHGmqe1K.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, {
						className: "max-w-[1560px] px-6 sm:px-8 lg:px-12 xl:px-16",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "grid items-center gap-10 lg:gap-14 xl:gap-20 lg:grid-cols-[1.08fr_1fr]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "w-full max-w-[720px] lg:max-w-none",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mb-5 inline-flex items-center rounded-full bg-[#edf4ff] border border-[#d4e4fa] px-4.5 py-1.5 text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.15em] text-[#1d63ed]",
										children: "ПРО КОМПАНІЮ"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
										className: "mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-[50px] xl:text-[56px] font-black tracking-tight leading-[1.08] text-[#0b192c]",
										children: ["ОСНОВА ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-[#1d63ed]",
											children: "Реабілітація"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mb-8 h-[4px] w-20 rounded-full bg-gradient-to-r from-[#1d63ed] via-[#1d63ed] 50% to-[#10b981]" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "space-y-5 sm:space-y-6 text-base sm:text-[17px] lg:text-[17px] xl:text-[18px] leading-[1.7] sm:leading-[1.75]",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "py-1 font-bold text-[#1d63ed]",
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "overflow-hidden rounded-[28px] lg:rounded-[32px] bg-white shadow-[0_12px_32px_rgba(0,0,0,0.05)] border border-slate-100/90 aspect-[4/3.3] min-h-[220px] sm:min-h-[260px] lg:min-h-[280px] xl:min-h-[300px]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex flex-col justify-center rounded-[28px] lg:rounded-[32px] bg-[#edf4ff] p-7 sm:p-8 lg:p-9 text-left border border-[#e2edfd] shadow-[0_12px_32px_rgba(0,0,0,0.03)] aspect-[4/3.3] min-h-[220px] sm:min-h-[260px] lg:min-h-[280px] xl:min-h-[300px] transition-all duration-300 hover:shadow-[0_16px_36px_rgba(29,99,237,0.08)]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mb-3 text-4xl sm:text-5xl lg:text-[58px] xl:text-[64px] font-black tracking-tight text-[#1d63ed] leading-none",
												children: "8+"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-xs sm:text-sm lg:text-base font-bold text-[#334155] leading-snug",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mb-3 text-4xl sm:text-5xl lg:text-[58px] xl:text-[64px] font-black tracking-tight text-[#0b192c] leading-none",
												children: "30+"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-xs sm:text-sm lg:text-base font-bold text-[#334155] leading-snug",
