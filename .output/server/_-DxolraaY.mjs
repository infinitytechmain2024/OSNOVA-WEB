...
import { t as Route$1 } from "./_-Oe5gCtXi.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-DxolraaY.js
...
var CARDIO_PROGRAMS = CARDIO_REHAB_PROGRAMS.map((program) => ({
	title: program.title,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				children: card.text
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: isPostInfarctionCard ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLink, {
				to: infarctionRoute,
...
function OtherServicesSlider() {
	...
	const isLastSlide = active === OTHER_SERVICES$1.length - 1;
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: OTHER_SERVICES$1.map((service) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: OTHER_SERVICES$1.map((service, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							onClick: () => scrollToIndex(Math.min(OTHER_SERVICES$1.length - 1, active + 1)),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionIntro$1, {
							...
							children: INDICATIONS$1.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container$1, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container$1, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionIntro, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container$1, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionIntro, {
						...
						children: METHODS$1.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container$1, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container$1, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function PostInfarctionRehabPage({ node }) {
	const { openModal } = useConsultationModal();
	const [faqExpanded, setFaqExpanded] = import_react.useState(false);
	const [activeOtherService, setActiveOtherService] = import_react.useState(0);
	const otherServicesTrackRef = import_react.useRef(null);
	const faqItems = faqExpanded ? node.faq ?? [] : (node.faq ?? []).slice(0, 3);
	const scrollOtherServicesToIndex = (index) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						className: "bg-white px-4 pt-4 sm:px-6 sm:pt-6 lg:px-8",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative mx-auto max-w-[1800px] overflow-hidden rounded-[40px] bg-navy-deep",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: cardio_rehab_cta_photo_v3_default,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[linear-gradient(90deg,rgba(8,23,58,0.96)_0%,rgba(8,23,58,0.88)_34%,rgba(8,23,58,0.54)_62%,rgba(8,23,58,0.1)_100%)]" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "relative mx-auto flex min-h-[500px] max-w-[1800px] items-center px-6 py-14 sm:px-10 lg:min-h-[560px] lg:px-16 lg:py-20",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "max-w-[620px]",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "inline-flex rounded-full border border-white/20 bg-white px-5 py-2 text-xs font-bold uppercase tracking-[0.16em] text-primary shadow-[0_14px_38px_rgba(10,25,60,0.18)]",
												children: "Кардіологічна реабілітація"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
												className: "mt-6 max-w-[10ch] text-4xl font-extrabold leading-[0.95] text-white sm:text-5xl lg:text-[4.6rem]",
												children: "Реабілітація після інфаркту міокарда"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "mt-5 max-w-[30rem] text-base leading-relaxed text-white/84 sm:text-lg",
												children: "Індивідуальна програма відновлення для безпечного повернення до активного життя під контролем фахівців."
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												type: "button",
												...
												children: ["Замовити консультацію", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4" })]
											})
										]
									})
								})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						className: "bg-white",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Breadcrumbs, {
							items: [
								{
									title: "Головна",
									route: "/"
								...
								},
								{
									...
									route: "/reabilitatsiia/kardiolohichna"
								},
								{
									title: node.title,
									route: node.route
							...
							className: "overflow-x-auto pb-5 scrollbar-none",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
								"aria-label": "Навігація по сторінці",
								className: "flex min-w-max gap-2",
								children: ANCHORS.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									href: item.href,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						id: "about",
						className: "bg-white pb-6 pt-2 sm:pb-8",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-[30px] border border-sky-100 bg-[linear-gradient(180deg,#f7fbff_0%,#f3f8ff_100%)] p-6 shadow-[0_18px_55px_rgba(31,61,120,0.06)] sm:p-8 lg:p-10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "grid items-center gap-8 lg:grid-cols-[320px_1fr] xl:grid-cols-[360px_1fr]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										...
										children: "Що таке інфаркт міокарда"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 max-w-4xl text-sm leading-relaxed text-navy/74 sm:text-base",
										children: "Інфаркт міокарда — це гостре порушення кровопостачання частини серцевого м'яза, внаслідок якого його тканини можуть пошкоджуватися. Після стабілізації стану важливо не лише продовжувати лікування, а й поступово повертатися до безпечної фізичної активності."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
										className: "mt-6 space-y-3",
										children: ABOUT_POINTS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
											className: "flex items-start gap-3 text-sm text-navy/78",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mt-0.5 size-5 shrink-0 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item })]
										}, item))
									})
								] })]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-8 flex items-start gap-3 rounded-[22px] border border-primary/10 bg-white/80 px-5 py-4 text-sm font-semibold text-primary",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, { className: "mt-0.5 size-5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Реабілітація допомагає поступово відновлювати активність та формувати безпечний маршрут повернення до повсякденного життя." })]
							})]
						}) })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "text-3xl font-extrabold text-navy sm:text-4xl",
								children: "Що варто знати перед початком програми"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 rounded-full border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-navy/62",
								children: "Показання та можливі обмеження оцінюються лікарем індивідуально перед початком програми."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-6 overflow-hidden rounded-[28px] border border-sky-100 bg-[linear-gradient(90deg,#f5f9ff_0%,#ffffff_56%)]",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												...
												children: "Реабілітацію можна розпочинати після стабілізації стану та за рекомендацією лікаря. Зазвичай це відбувається від кількох днів до кількох тижнів після події залежно від клінічної ситуації та типу втручання."
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "mt-4 text-sm leading-relaxed text-navy/74 sm:text-base",
												children: "Перший етап проходить під наглядом фахівців із поступовим збільшенням навантажень."
											})
										]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-5 grid gap-3 rounded-[28px] border border-red-200 bg-red-50/70 p-5 lg:grid-cols-[1fr_1fr]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-3 text-red-500",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, { className: "size-6" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-2xl font-extrabold",
										children: "Знаки невідкладного стану"
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 text-sm leading-relaxed text-red-500/80",
									children: "Не відкладайте звернення по допомогу, якщо з'являються такі симптоми. У разі їх виникнення негайно викликайте швидку медичну допомогу."
								})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
									className: "space-y-3 self-center",
									children: EMERGENCY_SIGNS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex gap-3 text-sm text-red-500/90",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mt-2 size-1.5 shrink-0 rounded-full bg-red-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item })]
									}, item))
								})]
							})
						] })
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
								title: "Коли може бути потрібна реабілітація після інфаркту",
								centered: true
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-8 grid gap-5 xl:grid-cols-3",
								children: SITUATIONS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						className: "bg-white py-6 sm:py-10",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-[30px] border border-sky-100 bg-[linear-gradient(180deg,#f6fbff_0%,#f4f8ff_100%)] p-6 sm:p-8 lg:p-10",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "mt-8 grid gap-4 xl:grid-cols-5",
									children: PROCESS_STEPS.map((step, index) => {
										const Icon = step.icon;
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "flex size-12 items-center justify-center rounded-2xl bg-brand-green/12 text-brand-green",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "size-6" })
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
													className: "mt-4 text-lg font-extrabold text-navy",
													children: step.title
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "mt-3 text-sm leading-relaxed text-navy/72",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mt-6 flex flex-wrap items-center gap-3 rounded-[20px] border border-white/80 bg-white/70 px-5 py-4 text-sm text-navy/72",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "font-bold text-navy",
											children: "Формати надання допомоги"
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: "стаціонарно"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "font-semibold text-primary",
											children: "амбулаторно"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "font-semibold text-primary",
											children: "онлайн"
							...
							children: [METHODS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: ["Перейти далі", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4" })]
									})
								]
							}, item.title)), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "rounded-[24px] bg-[linear-gradient(180deg,#dffbe9_0%,#b8f1cc_100%)] p-6 text-navy shadow-[0_16px_40px_rgba(53,200,138,0.16)] xl:col-span-1",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-3 text-brand-green",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-6" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-sm font-bold uppercase tracking-[0.14em]",
											children: "Акції та спецумови"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 text-4xl font-extrabold text-brand-green",
										children: "до -15 %"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-sm leading-relaxed text-navy/74",
										children: "Дізнайтеся про актуальні акції та спеціальні умови на програми реабілітації."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
							...
							className: "mt-8 grid gap-5 xl:grid-cols-4",
							children: CARDIO_REHAB_PROGRAMS.map((program) => {
								const isFeatured = program.id === "standartna";
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
									className: cn("flex min-h-[320px] flex-col rounded-[24px] border p-6 shadow-[0_16px_36px_rgba(31,61,120,0.05)]", isFeatured ? "border-primary bg-primary text-white" : "border-slate-200 bg-white text-navy"),
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: cn("mt-3 text-sm leading-relaxed", isFeatured ? "text-white/82" : "text-navy/70"),
											children: program.description
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: cn("mt-6 space-y-4 border-t pt-5", isFeatured ? "border-white/20" : "border-slate-200"),
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "text-xs font-bold uppercase tracking-[0.14em] opacity-70",
												children: "Тривалість"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												className: "mt-1 text-[2rem] font-extrabold",
												children: program.price
											})] })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppLink, {
											to: program.detailsUrl,
											className: cn("mt-auto inline-flex min-h-11 w-fit items-center justify-center rounded-full px-5 py-3 text-sm font-bold transition-colors", isFeatured ? "bg-white text-primary hover:bg-white/90" : "border border-slate-200 text-primary hover:border-primary/30 hover:bg-sky-50"),
											children: "Детальніше"
										})
									]
								}, program.id);
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "text-3xl font-extrabold text-navy sm:text-4xl",
										children: "Потрібна допомога з вибором програми?"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 max-w-2xl text-sm leading-relaxed text-navy/72 sm:text-base",
										children: "Залиште заявку, і команда ОСНОВА допоможе зрозуміти, з чого почати відновлення після інфаркту."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, {
							...
							children: [
								...
								(node.faq?.length ?? 0) > 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "mt-6 flex justify-center",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										type: "button",
										onClick: () => setFaqExpanded((value) => !value),
										...
										children: [faqExpanded ? "Показати менше питань" : "Показати більше питань", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cn("size-4 transition-transform", faqExpanded && "rotate-180") })]
									})
								})
							]
						})
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: OTHER_SERVICES.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: OTHER_SERVICES.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										"aria-label": `Слайд ${index + 1}`,
										onClick: () => scrollOtherServicesToIndex(index),
										className: cn("h-2.5 rounded-full transition-all", index === activeOtherService ? "w-8 bg-primary" : "w-2.5 bg-navy/20")
									}, item.title))
								})
							]
						}) })
...
function SectionTitle({ title, text, centered }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn(centered && "text-center"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
			className: "text-3xl font-extrabold leading-tight text-navy sm:text-4xl",
			children: title
		}), text && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: cn("mt-4 max-w-3xl text-sm leading-relaxed text-navy/72 sm:text-base", centered && "mx-auto"),
			children: text
		})]
	});
}
function InfoCard({ title, icon: Icon, iconClassName, items, bulletClassName }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		className: "rounded-[26px] border border-slate-200 bg-white p-6 shadow-[0_12px_30px_rgba(31,61,120,0.04)] sm:p-7",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-3",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: cn("flex size-11 items-center justify-center rounded-2xl", iconClassName),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "size-5" })
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				className: "text-2xl font-extrabold text-navy",
				children: title
			...
			children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: cn("mt-2 size-1.5 shrink-0 rounded-full bg-primary", bulletClassName) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item })]
			}, item))
		})]
	});
}
