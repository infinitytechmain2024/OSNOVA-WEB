...
import { t as Route$1 } from "./_-CkDVgPxC.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_-CGNYb1ga.js
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader$1, {
							...
							className: "mt-8",
							children: BENEFITS$1.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionIntro$1, {
							...
							children: FORMATS$1.map((format) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionIntro$1, {
								...
								children: STEPS$2.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
...
function SectionHeading$1({ eyebrow, title, text, centered = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageContainer, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading$1, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading$1, {
							eyebrow: "Сервіс",
...
var METHOD_TEXT = {
	...
	"Моніторинг тиску, пульсу та самопочуття": "Контроль основних показників під час і після фізичної активності.",
	...
	"Рекомендації щодо способу життя": "Рухова активність, сон, харчування, звички та подальша профілактика."
};
var FORMATS = [
	{
		title: "Стаціонарно",
...
function PostInfarctionRehabPage({ node }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "relative overflow-hidden bg-[linear-gradient(180deg,#ffffff_0%,#f1f7ff_100%)]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-y-0 right-0 hidden w-[48%] bg-[radial-gradient(circle_at_top_left,rgba(47,99,190,0.14),transparent_55%)] lg:block" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mx-auto grid max-w-[1600px] gap-10 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-[0.92fr_1.08fr] lg:px-10 lg:py-16",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col justify-center",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Breadcrumbs, {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "inline-flex w-fit rounded-full border border-primary/15 bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-primary shadow-sm",
									children: "Кардіологічна реабілітація"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									className: "mt-5 max-w-3xl text-4xl font-extrabold leading-[1.02] text-navy sm:text-5xl lg:text-6xl",
									children: "Реабілітація після інфаркту міокарда"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-5 max-w-2xl text-lg leading-relaxed text-navy/80",
									children: "Допомагаємо безпечно повернутися до активності, відновити витривалість і сформувати зрозумілий план подальшого відновлення."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-4 max-w-xl text-base leading-relaxed text-navy/68",
									children: "Програма формується індивідуально після оцінки стану, рекомендацій лікаря та результатів обстежень."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: "relative overflow-hidden rounded-[32px] border border-sky-100 bg-white shadow-[0_30px_70px_rgba(31,61,120,0.12)]",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: cardio_rehab_cta_photo_v3_default,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mx-auto max-w-[1600px] overflow-x-auto px-4 py-4 sm:px-6 lg:px-10",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					id: "for-whom",
					className: "scroll-mt-24 bg-[#f4f9ff] py-14 sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
						...
						children: SUITABLE_FOR.map((item) => {
							const Icon = item.icon;
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "rounded-[26px] border border-sky-100 bg-white p-6 shadow-[0_18px_40px_rgba(31,61,120,0.06)]",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "flex size-14 items-center justify-center rounded-2xl bg-primary/8 text-primary",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
											className: "size-7",
											strokeWidth: 2.1
										})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					id: "benefits",
					className: "scroll-mt-24 bg-navy py-14 text-white sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
						...
						children: BENEFITS.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							className: cn("rounded-[28px] border p-6 sm:p-7", index === 0 || index === 3 ? "border-white/12 bg-white/8" : "border-sky-300/14 bg-sky-400/8"),
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "text-sm font-bold uppercase tracking-[0.16em] text-sky-200",
									children: ["0", index + 1]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 max-w-md text-sm leading-relaxed text-white/76",
									children: item.text
								})
							]
						}, item.title))
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
						...
						className: "mt-12 grid gap-6 lg:grid-cols-[0.84fr_1.16fr]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: STEPS.map((step, index) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
									...
									children: [index < STEPS.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute left-10 top-[100%] hidden h-6 w-px bg-primary/25 sm:block" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex gap-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "flex size-12 shrink-0 items-center justify-center rounded-2xl bg-primary text-white",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
												className: "size-5",
												strokeWidth: 2.2
											})
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "text-xs font-bold uppercase tracking-[0.16em] text-primary/72",
												children: ["Етап ", index + 1]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					id: "methods",
					className: "scroll-mt-24 bg-white pb-14 sm:pb-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[34px] bg-[linear-gradient(180deg,#ecf5ff_0%,#f6fbff_100%)] p-6 sm:p-8 lg:p-10",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: METHODS.map((title, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
									className: cn("rounded-[24px] border p-5", index % 3 === 0 ? "border-primary/12 bg-white" : "border-white/80 bg-white/70"),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-lg font-extrabold text-navy",
										children: title
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-2 text-sm leading-relaxed text-navy/72",
										children: METHOD_TEXT[title]
									})]
								}, title))
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-6 max-w-4xl text-sm leading-relaxed text-navy/66",
								children: "Конкретний набір методів визначається індивідуально залежно від стану пацієнта, етапу відновлення та рекомендацій лікаря."
							})
						]
					}) })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					id: "formats",
					className: "scroll-mt-24 bg-white py-14 sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, { title: "Формати участі" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-10 grid gap-5 lg:grid-cols-3",
						children: FORMATS.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							className: cn("rounded-[30px] border p-6 sm:p-7", index === 1 ? "border-primary/18 bg-[linear-gradient(180deg,#ffffff_0%,#f2f8ff_100%)]" : "border-slate-200 bg-white"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "bg-[#f8fbff] py-14 sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, { title: "Яких результатів можна очікувати" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-5",
							children: RESULTS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex gap-3 rounded-2xl bg-white px-4 py-4 shadow-sm",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mt-0.5 size-5 shrink-0 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm leading-relaxed text-navy/76",
									children: item
								})]
							}, item))
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-6 max-w-4xl text-sm leading-relaxed text-navy/64",
							children: "Результат залежить від вихідного стану, супутніх захворювань, регулярності занять та дотримання рекомендацій."
						})
					] })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Container, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
						...
						className: "mt-10 grid gap-5 xl:grid-cols-[repeat(4,minmax(0,1fr))_0.88fr]",
						children: [CARDIO_REHAB_PROGRAMS.map((program) => {
							const popular = program.id === "standartna";
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: cn("flex min-h-[310px] flex-col rounded-[28px] p-6", popular ? "bg-primary text-white" : "bg-white text-navy"),
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											...
											children: program.title
										}), popular && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "rounded-full bg-white px-3 py-1 text-xs font-bold uppercase tracking-[0.14em] text-primary",
											children: "Основна"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: cn("mt-3 text-sm leading-relaxed", popular ? "text-white/78" : "text-navy/70"),
										children: program.description
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: cn("mt-6 border-t pt-5", popular ? "border-white/18" : "border-slate-200"),
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "text-xs font-bold uppercase tracking-[0.16em] opacity-70",
												children: "Тривалість"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mt-4 text-xs font-bold uppercase tracking-[0.16em] opacity-70",
												children: "Вартість"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mt-1 text-[1.7rem] font-extrabold",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLink, {
										...
										className: cn("mt-auto inline-flex w-fit items-center gap-2 rounded-xl px-5 py-3 text-sm font-bold transition-colors", popular ? "bg-white text-primary hover:bg-white/92" : "bg-primary text-white hover:bg-primary/90"),
										children: ["Детальніше", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4" })]
									})
								]
							}, program.id);
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
							className: "rounded-[28px] border border-white/12 bg-white/8 p-5 text-white",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "text-xl font-extrabold",
								children: "Акції та спецумови"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 text-sm leading-relaxed text-white/74",
								children: "Адміністратор підкаже актуальні умови для старту програми після попереднього ознайомлення з документами."
							})]
						})]
					})] })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "bg-[#f4f9ff] py-14 sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid gap-8 overflow-hidden rounded-[34px] border border-sky-100 bg-white p-6 shadow-[0_22px_55px_rgba(31,61,120,0.08)] lg:grid-cols-[0.9fr_1.1fr] lg:p-8",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col justify-center",
							...
							className: "overflow-hidden rounded-[28px] bg-slate-50",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: service_rehab_default,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					id: "faq",
					className: "scroll-mt-24 bg-[#f8fbff] py-14 sm:py-20",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					className: "bg-navy py-14 text-white sm:py-20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Container, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-5 max-w-2xl text-base leading-relaxed text-white/76 sm:text-lg",
								children: "Допоможемо зрозуміти, який формат відновлення може підійти саме у вашій ситуації."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function SectionHeading({ title, text, inverse, centered }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn(centered && "text-center"),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: cn("text-3xl font-extrabold leading-tight sm:text-4xl", inverse ? "text-white" : "text-navy"),
				children: title
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("mt-4 h-1 w-16 rounded-full bg-primary", centered && "mx-auto") }),
			text && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: cn("mt-4 max-w-3xl text-base leading-relaxed", inverse ? "text-white/74" : "text-navy/72", centered && "mx-auto"),
				children: text
			})
		]
	});
